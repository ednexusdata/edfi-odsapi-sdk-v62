...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public class EdFiOrganizationDepartmentJsonConverter : JsonConverter<EdFiOrganizationDepartment>
    {
        ...
        public override EdFiOrganizationDepartment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<int?> organizationDepartmentId = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "organizationDepartmentId":
                            organizationDepartmentId = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
            ...
            return new EdFiOrganizationDepartment(categories.Value!, organizationDepartmentId.Value!.Value!, nameOfInstitution.Value!, id, parentEducationOrganizationReference, academicSubjectDescriptor, addresses, identificationCodes, indicators, institutionTelephones, internationalAddresses, operationalStatusDescriptor, shortNameOfInstitution, webSite, etag, ext);
        }
