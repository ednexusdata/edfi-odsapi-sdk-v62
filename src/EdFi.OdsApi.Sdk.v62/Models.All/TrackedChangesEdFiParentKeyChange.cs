...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_parentKeyChange")]
    public partial class TrackedChangesEdFiParentKeyChange : IValidatableObject
    {
        ...
        public TrackedChangesEdFiParentKeyChange(string id = default, decimal changeVersion = default, TrackedChangesEdFiParentKey oldKeyValues = default, TrackedChangesEdFiParentKey newKeyValues = default)
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiParentKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiParentKey NewKeyValues { get; set; }
