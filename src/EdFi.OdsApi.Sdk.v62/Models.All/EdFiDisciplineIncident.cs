    ...
    public class EdFiDisciplineIncidentJsonConverter : JsonConverter<EdFiDisciplineIncident>
    {
        ...
        public override EdFiDisciplineIncident Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (staffReference.IsSet && staffReference.Value == null)
                throw new ArgumentNullException(nameof(staffReference), "Property is not nullable for class EdFiDisciplineIncident.");
            ...
            return new EdFiDisciplineIncident(incidentIdentifier.Value!, schoolReference.Value!, incidentDate.Value!.Value!, id, staffReference, behaviors, caseNumber, externalParticipants, incidentCost, incidentDescription, incidentLocationDescriptor, incidentTime, reportedToLawEnforcement, reporterDescriptionDescriptor, reporterName, weapons, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiDisciplineIncident edFiDisciplineIncident, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiDisciplineIncident.StaffReferenceOption.IsSet && edFiDisciplineIncident.StaffReference == null)
                throw new ArgumentNullException(nameof(edFiDisciplineIncident.StaffReference), "Property is required for class EdFiDisciplineIncident.");
            ...
            if (edFiDisciplineIncident.StaffReferenceOption.IsSet)
            {
                writer.WritePropertyName("staffReference");
                JsonSerializer.Serialize(writer, edFiDisciplineIncident.StaffReference, jsonSerializerOptions);
            }
