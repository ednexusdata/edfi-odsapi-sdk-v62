...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiReportCard : IValidatableObject
    {
        ...
        /// <param name="studentLearningObjectives">An unordered collection of reportCardStudentLearningObjectives. The student learning objective evaluations associated for this grading period.</param>
        /// <param name="etag">A unique system-generated value that identifies the version of the resource.</param>
        /// <param name="ext">Extensions to the ReportCard entity.</param>
        [JsonConstructor]
        public EdFiReportCard(EdFiEducationOrganizationReference educationOrganizationReference, EdFiGradingPeriodReference gradingPeriodReference, EdFiStudentReference studentReference, Option<string?> id = default, Option<double?> gpaCumulative = default, Option<double?> gpaGivenGradingPeriod = default, Option<List<EdFiReportCardGradePointAverage>?> gradePointAverages = default, Option<List<EdFiReportCardGrade>?> grades = default, Option<double?> numberOfDaysAbsent = default, Option<double?> numberOfDaysInAttendance = default, Option<int?> numberOfDaysTardy = default, Option<List<EdFiReportCardStudentCompetencyObjective>?> studentCompetencyObjectives = default, Option<List<EdFiReportCardStudentLearningObjective>?> studentLearningObjectives = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
            EducationOrganizationReference = educationOrganizationReference;
            GradingPeriodReference = gradingPeriodReference;
            StudentReference = studentReference;
            IdOption = id;
            GpaCumulativeOption = gpaCumulative;
            GpaGivenGradingPeriodOption = gpaGivenGradingPeriod;
            ...
            StudentLearningObjectivesOption = studentLearningObjectives;
            EtagOption = etag;
            ExtOption = ext;
            OnCreated();
        }
        ...
        /// <summary>
        /// Used to track the state of GpaCumulative
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<double?> GpaCumulativeOption { get; private set; }
        ...
        [JsonPropertyName("gpaCumulative")]
        public double? GpaCumulative { get { return this.GpaCumulativeOption; } set { this.GpaCumulativeOption = new(value); } }

        /// <summary>
        /// Used to track the state of GpaGivenGradingPeriod
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<double?> GpaGivenGradingPeriodOption { get; private set; }
        ...
        [JsonPropertyName("gpaGivenGradingPeriod")]
        public double? GpaGivenGradingPeriod { get { return this.GpaGivenGradingPeriodOption; } set { this.GpaGivenGradingPeriodOption = new(value); } }
        ...
        /// <summary>
        /// Used to track the state of StudentLearningObjectives
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiReportCardStudentLearningObjective>?> StudentLearningObjectivesOption { get; private set; }

        /// <summary>
        /// An unordered collection of reportCardStudentLearningObjectives. The student learning objective evaluations associated for this grading period.
        /// </summary>
        /// <value>An unordered collection of reportCardStudentLearningObjectives. The student learning objective evaluations associated for this grading period.</value>
        [JsonPropertyName("studentLearningObjectives")]
        public List<EdFiReportCardStudentLearningObjective>? StudentLearningObjectives { get { return this.StudentLearningObjectivesOption; } set { this.StudentLearningObjectivesOption = new(value); } }
    ...
    public class EdFiReportCardJsonConverter : JsonConverter<EdFiReportCard>
    {
        ...
        public override EdFiReportCard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<double?> gpaCumulative = default;
            Option<double?> gpaGivenGradingPeriod = default;
            ...
            Option<List<EdFiReportCardStudentLearningObjective>?> studentLearningObjectives = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "id":
                            ...
                            break;
                        case "gpaCumulative":
                            gpaCumulative = new Option<double?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (double?)null : utf8JsonReader.GetDouble());
                            break;
                        case "gpaGivenGradingPeriod":
                            gpaGivenGradingPeriod = new Option<double?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (double?)null : utf8JsonReader.GetDouble());
                            break;
                        ...
                        case "studentCompetencyObjectives":
                            ...
                            break;
                        case "studentLearningObjectives":
                            studentLearningObjectives = new Option<List<EdFiReportCardStudentLearningObjective>?>(JsonSerializer.Deserialize<List<EdFiReportCardStudentLearningObjective>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "_etag":
            ...
            if (studentLearningObjectives.IsSet && studentLearningObjectives.Value == null)
                throw new ArgumentNullException(nameof(studentLearningObjectives), "Property is not nullable for class EdFiReportCard.");
            ...
            return new EdFiReportCard(educationOrganizationReference.Value!, gradingPeriodReference.Value!, studentReference.Value!, id, gpaCumulative, gpaGivenGradingPeriod, gradePointAverages, grades, numberOfDaysAbsent, numberOfDaysInAttendance, numberOfDaysTardy, studentCompetencyObjectives, studentLearningObjectives, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiReportCard edFiReportCard, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiReportCard.StudentLearningObjectivesOption.IsSet && edFiReportCard.StudentLearningObjectives == null)
                throw new ArgumentNullException(nameof(edFiReportCard.StudentLearningObjectives), "Property is required for class EdFiReportCard.");
            ...
            if (edFiReportCard.GpaCumulativeOption.IsSet)
                if (edFiReportCard.GpaCumulativeOption.Value != null)
                    writer.WriteNumber("gpaCumulative", edFiReportCard.GpaCumulativeOption.Value!.Value);
                else
                    writer.WriteNull("gpaCumulative");

            if (edFiReportCard.GpaGivenGradingPeriodOption.IsSet)
                if (edFiReportCard.GpaGivenGradingPeriodOption.Value != null)
                    writer.WriteNumber("gpaGivenGradingPeriod", edFiReportCard.GpaGivenGradingPeriodOption.Value!.Value);
                else
                    writer.WriteNull("gpaGivenGradingPeriod");
            ...
            if (edFiReportCard.StudentLearningObjectivesOption.IsSet)
            {
                writer.WritePropertyName("studentLearningObjectives");
                JsonSerializer.Serialize(writer, edFiReportCard.StudentLearningObjectives, jsonSerializerOptions);
            }
