...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public class EdFiSurveyQuestionJsonConverter : JsonConverter<EdFiSurveyQuestion>
    {
        ...
        public override EdFiSurveyQuestion Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiSurveyQuestion(questionCode.Value!, surveyReference.Value!, questionFormDescriptor.Value!, questionText.Value!, id, surveySectionReference, matrices, responseChoices, etag, ext);
        }
