...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiDisciplineActionLengthDifferenceReasonDescriptor : IValidatableObject
    {
        ...
        public EdFiDisciplineActionLengthDifferenceReasonDescriptor(string id = default, int disciplineActionLengthDifferenceReasonDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
