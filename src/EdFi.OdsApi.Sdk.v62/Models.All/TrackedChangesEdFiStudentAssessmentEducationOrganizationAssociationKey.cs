...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey(string educationOrganizationAssociationTypeDescriptor = default, int educationOrganizationId = default, string assessmentIdentifier = default, string varNamespace = default, string studentAssessmentIdentifier = default, string studentUniqueId = default)
        {
