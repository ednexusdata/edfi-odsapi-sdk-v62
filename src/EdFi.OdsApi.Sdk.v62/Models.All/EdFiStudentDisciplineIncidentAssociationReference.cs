...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentDisciplineIncidentAssociationReference : IValidatableObject
    {
        ...
        public EdFiStudentDisciplineIncidentAssociationReference(string incidentIdentifier = default, int schoolId = default, string studentUniqueId = default, Link link = default)
        {
            // to ensure "incidentIdentifier" is required (not null)
            if (incidentIdentifier == null)
            {
                throw new ArgumentNullException("incidentIdentifier is a required property for EdFiStudentDisciplineIncidentAssociationReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("studentUniqueId is a required property for EdFiStudentDisciplineIncidentAssociationReference and cannot be null");
            }
