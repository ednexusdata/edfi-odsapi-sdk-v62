...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiAcademicWeek : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiAcademicWeek(string weekIdentifier, EdFiSchoolReference schoolReference, DateOnly beginDate, DateOnly endDate, int totalInstructionalDays, Option<string?> id = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiAcademicWeekJsonConverter : JsonConverter<EdFiAcademicWeek>
    {
        ...
        public override EdFiAcademicWeek Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiAcademicWeek(weekIdentifier.Value!, schoolReference.Value!, beginDate.Value!.Value!, endDate.Value!.Value!, totalInstructionalDays.Value!.Value!, id, etag, ext);
        }
