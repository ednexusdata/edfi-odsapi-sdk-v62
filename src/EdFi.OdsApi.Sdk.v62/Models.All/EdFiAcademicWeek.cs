...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiAcademicWeek : IValidatableObject
    {
        ...
        public EdFiAcademicWeek(string id = default, string weekIdentifier = default, EdFiSchoolReference schoolReference = default, DateOnly beginDate = default, DateOnly endDate = default, int totalInstructionalDays = default, string etag = default, Object ext = default)
        {
