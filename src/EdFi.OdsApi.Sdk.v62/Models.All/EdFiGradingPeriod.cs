...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiGradingPeriod : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiGradingPeriod(string gradingPeriodDescriptor, int periodSequence, EdFiSchoolReference schoolReference, EdFiSchoolYearTypeReference schoolYearTypeReference, DateOnly beginDate, DateOnly endDate, int totalInstructionalDays, Option<string?> id = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiGradingPeriodJsonConverter : JsonConverter<EdFiGradingPeriod>
    {
        ...
        public override EdFiGradingPeriod Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!periodSequence.IsSet)
                throw new ArgumentException("Property is required for class EdFiGradingPeriod.", nameof(periodSequence));
            ...
            if (periodSequence.IsSet && periodSequence.Value == null)
                throw new ArgumentNullException(nameof(periodSequence), "Property is not nullable for class EdFiGradingPeriod.");
            ...
            return new EdFiGradingPeriod(gradingPeriodDescriptor.Value!, periodSequence.Value!.Value!, schoolReference.Value!, schoolYearTypeReference.Value!, beginDate.Value!.Value!, endDate.Value!.Value!, totalInstructionalDays.Value!.Value!, id, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiGradingPeriod edFiGradingPeriod, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteNumber("periodSequence", edFiGradingPeriod.PeriodSequence);
