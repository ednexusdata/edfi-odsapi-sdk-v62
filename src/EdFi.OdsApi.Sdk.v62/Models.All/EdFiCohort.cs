...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiCohort : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for CohortIdentifier, length must be less than 20.", new [] { "CohortIdentifier" });
            }
    ...
    public class EdFiCohortJsonConverter : JsonConverter<EdFiCohort>
    {
        ...
        public override EdFiCohort Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiCohort(cohortIdentifier.Value!, educationOrganizationReference.Value!, cohortTypeDescriptor.Value!, id, academicSubjectDescriptor, cohortDescription, cohortScopeDescriptor, programs, etag, ext);
        }
