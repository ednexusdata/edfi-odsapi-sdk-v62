...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveySectionResponseEducationOrganizationTargetAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiSurveySectionResponseEducationOrganizationTargetAssociationKey(int educationOrganizationId = default, string varNamespace = default, string surveyIdentifier = default, string surveyResponseIdentifier = default, string surveySectionTitle = default)
        {
