...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiAssessmentScoreRangeLearningStandard : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiAssessmentScoreRangeLearningStandard(List<EdFiAssessmentScoreRangeLearningStandardLearningStandard> learningStandards, string scoreRangeId, EdFiAssessmentReference assessmentReference, string maximumScore, string minimumScore, Option<string?> id = default, Option<EdFiObjectiveAssessmentReference?> objectiveAssessmentReference = default, Option<string?> assessmentReportingMethodDescriptor = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiAssessmentScoreRangeLearningStandardJsonConverter : JsonConverter<EdFiAssessmentScoreRangeLearningStandard>
    {
        ...
        public override EdFiAssessmentScoreRangeLearningStandard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiAssessmentScoreRangeLearningStandard(learningStandards.Value!, scoreRangeId.Value!, assessmentReference.Value!, maximumScore.Value!, minimumScore.Value!, id, objectiveAssessmentReference, assessmentReportingMethodDescriptor, etag, ext);
        }
