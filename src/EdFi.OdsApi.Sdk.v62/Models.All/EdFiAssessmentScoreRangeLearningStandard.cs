...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiAssessmentScoreRangeLearningStandard : IValidatableObject
    {
        ...
        public EdFiAssessmentScoreRangeLearningStandard(string id = default, List<EdFiAssessmentScoreRangeLearningStandardLearningStandard> learningStandards = default, string scoreRangeId = default, EdFiAssessmentReference assessmentReference = default, EdFiObjectiveAssessmentReference objectiveAssessmentReference = default, string assessmentReportingMethodDescriptor = default, string maximumScore = default, string minimumScore = default, string etag = default, Object ext = default)
        {
