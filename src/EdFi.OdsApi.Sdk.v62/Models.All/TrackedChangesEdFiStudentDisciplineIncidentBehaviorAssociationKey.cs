...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationKey(string behaviorDescriptor = default, string incidentIdentifier = default, int schoolId = default, string studentUniqueId = default)
        {
