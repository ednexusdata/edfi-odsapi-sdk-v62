...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiPostSecondaryEvent : IValidatableObject
    {
        ...
        public EdFiPostSecondaryEvent(string id = default, DateOnly eventDate = default, string postSecondaryEventCategoryDescriptor = default, EdFiPostSecondaryInstitutionReference postSecondaryInstitutionReference = default, EdFiStudentReference studentReference = default, string etag = default, Object ext = default)
        {
