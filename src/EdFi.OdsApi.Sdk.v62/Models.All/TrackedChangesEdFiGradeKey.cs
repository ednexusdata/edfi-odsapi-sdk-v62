    ...
    public class TrackedChangesEdFiGradeKeyJsonConverter : JsonConverter<TrackedChangesEdFiGradeKey>
    {
        ...
        public override TrackedChangesEdFiGradeKey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (gradingPeriodSequence.IsSet && gradingPeriodSequence.Value == null)
                throw new ArgumentNullException(nameof(gradingPeriodSequence), "Property is not nullable for class TrackedChangesEdFiGradeKey.");
            ...
            return new TrackedChangesEdFiGradeKey(gradeTypeDescriptor, gradingPeriodDescriptor, gradingPeriodSequence, schoolId, gradingPeriodSchoolYear, beginDate, localCourseCode, schoolYear, sectionIdentifier, sessionName, studentUniqueId);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, TrackedChangesEdFiGradeKey trackedChangesEdFiGradeKey, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (trackedChangesEdFiGradeKey.GradingPeriodSequenceOption.IsSet)
                writer.WriteNumber("gradingPeriodSequence", trackedChangesEdFiGradeKey.GradingPeriodSequenceOption.Value!.Value);
