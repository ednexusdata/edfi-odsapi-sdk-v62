...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStaffAbsenceEvent : IValidatableObject
    {
        ...
        public EdFiStaffAbsenceEvent(string id = default, string absenceEventCategoryDescriptor = default, DateOnly eventDate = default, EdFiStaffReference staffReference = default, string absenceEventReason = default, double? hoursAbsent = default, string etag = default, Object ext = default)
        {
