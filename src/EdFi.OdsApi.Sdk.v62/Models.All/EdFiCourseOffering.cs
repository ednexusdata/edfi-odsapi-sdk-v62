...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public class EdFiCourseOfferingJsonConverter : JsonConverter<EdFiCourseOffering>
    {
        ...
        public override EdFiCourseOffering Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiCourseOffering(localCourseCode.Value!, courseReference.Value!, schoolReference.Value!, sessionReference.Value!, id, courseLevelCharacteristics, curriculumUseds, instructionalTimePlanned, localCourseTitle, offeredGradeLevels, etag, ext);
        }
