...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentAcademicRecordKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiStudentAcademicRecordKey(Option<string?> termDescriptor = default, Option<int?> educationOrganizationId = default, Option<int?> schoolYear = default, Option<string?> studentUniqueId = default)
        {
