...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentAcademicRecordKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentAcademicRecordKey(string termDescriptor = default, int educationOrganizationId = default, int schoolYear = default, string studentUniqueId = default)
        {
