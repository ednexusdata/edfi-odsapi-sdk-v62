...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiAssessmentIdentificationSystemDescriptor : IValidatableObject
    {
        ...
        public EdFiAssessmentIdentificationSystemDescriptor(string id = default, int assessmentIdentificationSystemDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
