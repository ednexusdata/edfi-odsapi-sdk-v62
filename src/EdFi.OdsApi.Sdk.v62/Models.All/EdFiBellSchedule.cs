...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public class EdFiBellScheduleJsonConverter : JsonConverter<EdFiBellSchedule>
    {
        ...
        public override EdFiBellSchedule Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiBellSchedule(bellScheduleName.Value!, classPeriods.Value!, schoolReference.Value!, id, alternateDayName, dates, endTime, gradeLevels, startTime, totalInstructionalTime, etag, ext);
        }
