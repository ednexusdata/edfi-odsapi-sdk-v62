...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentCTEProgramAssociation : IValidatableObject
    {
        ...
        public EdFiStudentCTEProgramAssociation(string id = default, DateOnly beginDate = default, EdFiEducationOrganizationReference educationOrganizationReference = default, EdFiProgramReference programReference = default, EdFiStudentReference studentReference = default, List<EdFiStudentCTEProgramAssociationCTEProgram> ctePrograms = default, List<EdFiStudentCTEProgramAssociationCTEProgramService> cteProgramServices = default, DateOnly? endDate = default, bool? nonTraditionalGenderStatus = default, EdFiGeneralStudentProgramAssociationParticipationStatus participationStatus = default, bool? privateCTEProgram = default, List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default, string reasonExitedDescriptor = default, bool? servedOutsideOfRegularSession = default, List<EdFiStudentCTEProgramAssociationService> services = default, string technicalSkillsAssessmentDescriptor = default, string etag = default, Object ext = default)
        {
