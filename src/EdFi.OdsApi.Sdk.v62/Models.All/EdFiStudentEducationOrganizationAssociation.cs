...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentEducationOrganizationAssociation : IValidatableObject
    {
        ...
        /// <param name="sexDescriptor">The student&#39;s gender as last reported to the education organization.</param>
        ...
        [JsonConstructor]
        public EdFiStudentEducationOrganizationAssociation(EdFiEducationOrganizationReference educationOrganizationReference, EdFiStudentReference studentReference, string sexDescriptor, Option<string?> id = default, Option<List<EdFiStudentEducationOrganizationAssociationAddress>?> addresses = default, Option<List<EdFiStudentEducationOrganizationAssociationAncestryEthnicOrigin>?> ancestryEthnicOrigins = default, Option<string?> barrierToInternetAccessInResidenceDescriptor = default, Option<List<EdFiStudentEducationOrganizationAssociationCohortYear>?> cohortYears = default, Option<List<EdFiStudentEducationOrganizationAssociationDisability>?> disabilities = default, Option<List<EdFiStudentEducationOrganizationAssociationElectronicMail>?> electronicMails = default, Option<bool?> hispanicLatinoEthnicity = default, Option<List<EdFiStudentEducationOrganizationAssociationInternationalAddress>?> internationalAddresses = default, Option<bool?> internetAccessInResidence = default, Option<string?> internetAccessTypeInResidenceDescriptor = default, Option<string?> internetPerformanceInResidenceDescriptor = default, Option<List<EdFiStudentEducationOrganizationAssociationLanguage>?> languages = default, Option<string?> limitedEnglishProficiencyDescriptor = default, Option<string?> loginId = default, Option<string?> oldEthnicityDescriptor = default, Option<string?> primaryLearningDeviceAccessDescriptor = default, Option<string?> primaryLearningDeviceAwayFromSchoolDescriptor = default, Option<string?> primaryLearningDeviceProviderDescriptor = default, Option<string?> profileThumbnail = default, Option<List<EdFiStudentEducationOrganizationAssociationProgramParticipation>?> programParticipations = default, Option<List<EdFiStudentEducationOrganizationAssociationRace>?> races = default, Option<List<EdFiStudentEducationOrganizationAssociationStudentCharacteristic>?> studentCharacteristics = default, Option<List<EdFiStudentEducationOrganizationAssociationStudentIdentificationCode>?> studentIdentificationCodes = default, Option<List<EdFiStudentEducationOrganizationAssociationStudentIndicator>?> studentIndicators = default, Option<List<EdFiStudentEducationOrganizationAssociationTelephone>?> telephones = default, Option<List<EdFiStudentEducationOrganizationAssociationTribalAffiliation>?> tribalAffiliations = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
            ...
            ProgramParticipationsOption = programParticipations;
            RacesOption = races;
        ...
        /// <summary>
        /// Used to track the state of ProgramParticipations
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiStudentEducationOrganizationAssociationProgramParticipation>?> ProgramParticipationsOption { get; private set; }
        ...
        [JsonPropertyName("programParticipations")]
        public List<EdFiStudentEducationOrganizationAssociationProgramParticipation>? ProgramParticipations { get { return this.ProgramParticipationsOption; } set { this.ProgramParticipationsOption = new(value); } }
    ...
    public class EdFiStudentEducationOrganizationAssociationJsonConverter : JsonConverter<EdFiStudentEducationOrganizationAssociation>
    {
        ...
        public override EdFiStudentEducationOrganizationAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EdFiStudentEducationOrganizationAssociationProgramParticipation>?> programParticipations = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "profileThumbnail":
                            ...
                            break;
                        case "programParticipations":
                            programParticipations = new Option<List<EdFiStudentEducationOrganizationAssociationProgramParticipation>?>(JsonSerializer.Deserialize<List<EdFiStudentEducationOrganizationAssociationProgramParticipation>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "races":
            ...
            if (!sexDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiStudentEducationOrganizationAssociation.", nameof(sexDescriptor));
            ...
            if (sexDescriptor.IsSet && sexDescriptor.Value == null)
                throw new ArgumentNullException(nameof(sexDescriptor), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");
            ...
            if (programParticipations.IsSet && programParticipations.Value == null)
                throw new ArgumentNullException(nameof(programParticipations), "Property is not nullable for class EdFiStudentEducationOrganizationAssociation.");
            ...
            return new EdFiStudentEducationOrganizationAssociation(educationOrganizationReference.Value!, studentReference.Value!, sexDescriptor.Value!, id, addresses, ancestryEthnicOrigins, barrierToInternetAccessInResidenceDescriptor, cohortYears, disabilities, electronicMails, hispanicLatinoEthnicity, internationalAddresses, internetAccessInResidence, internetAccessTypeInResidenceDescriptor, internetPerformanceInResidenceDescriptor, languages, limitedEnglishProficiencyDescriptor, loginId, oldEthnicityDescriptor, primaryLearningDeviceAccessDescriptor, primaryLearningDeviceAwayFromSchoolDescriptor, primaryLearningDeviceProviderDescriptor, profileThumbnail, programParticipations, races, studentCharacteristics, studentIdentificationCodes, studentIndicators, telephones, tribalAffiliations, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentEducationOrganizationAssociation edFiStudentEducationOrganizationAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentEducationOrganizationAssociation.SexDescriptor == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociation.SexDescriptor), "Property is required for class EdFiStudentEducationOrganizationAssociation.");
            ...
            if (edFiStudentEducationOrganizationAssociation.ProgramParticipationsOption.IsSet && edFiStudentEducationOrganizationAssociation.ProgramParticipations == null)
                throw new ArgumentNullException(nameof(edFiStudentEducationOrganizationAssociation.ProgramParticipations), "Property is required for class EdFiStudentEducationOrganizationAssociation.");
            ...
            if (edFiStudentEducationOrganizationAssociation.OldEthnicityDescriptorOption.IsSet)
                if (edFiStudentEducationOrganizationAssociation.OldEthnicityDescriptorOption.Value != null)
                    writer.WriteString("oldEthnicityDescriptor", edFiStudentEducationOrganizationAssociation.OldEthnicityDescriptor);
                else
            ...
            if (edFiStudentEducationOrganizationAssociation.ProgramParticipationsOption.IsSet)
            {
                writer.WritePropertyName("programParticipations");
                JsonSerializer.Serialize(writer, edFiStudentEducationOrganizationAssociation.ProgramParticipations, jsonSerializerOptions);
            }
