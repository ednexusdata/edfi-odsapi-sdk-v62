...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiRecognitionTypeDescriptor : IValidatableObject
    {
        ...
        public EdFiRecognitionTypeDescriptor(string id = default, int recognitionTypeDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
