...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiGraduationPlanKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiGraduationPlanKey(Option<string?> graduationPlanTypeDescriptor = default, Option<int?> educationOrganizationId = default, Option<int?> graduationSchoolYear = default)
        {
