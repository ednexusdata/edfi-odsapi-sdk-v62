...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiGraduationPlanKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiGraduationPlanKey(string graduationPlanTypeDescriptor = default, int educationOrganizationId = default, int graduationSchoolYear = default)
        {
