...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public class EdFiAssessmentItemJsonConverter : JsonConverter<EdFiAssessmentItem>
    {
        ...
        public override EdFiAssessmentItem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiAssessmentItem(identificationCode.Value!, assessmentReference.Value!, id, assessmentItemCategoryDescriptor, assessmentItemURI, expectedTimeAssessed, itemText, learningStandards, maxRawScore, nomenclature, possibleResponses, etag, ext);
        }
