...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiLocalEncumbranceKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiLocalEncumbranceKey(DateOnly asOfDate = default, string accountIdentifier = default, int educationOrganizationId = default, int fiscalYear = default)
        {
