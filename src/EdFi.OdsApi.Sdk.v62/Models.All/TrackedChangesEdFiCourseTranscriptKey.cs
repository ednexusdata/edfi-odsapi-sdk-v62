...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiCourseTranscriptKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiCourseTranscriptKey(string courseAttemptResultDescriptor = default, string courseCode = default, int courseEducationOrganizationId = default, int educationOrganizationId = default, int schoolYear = default, string studentUniqueId = default, string termDescriptor = default)
        {
