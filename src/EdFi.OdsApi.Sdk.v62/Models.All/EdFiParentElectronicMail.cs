...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiParentElectronicMail : IValidatableObject
    {
        ...
        public EdFiParentElectronicMail(string electronicMailTypeDescriptor = default, string electronicMailAddress = default, bool? doNotPublishIndicator = default, bool? primaryEmailAddressIndicator = default, Object ext = default)
        {
            // to ensure "electronicMailTypeDescriptor" is required (not null)
            if (electronicMailTypeDescriptor == null)
            {
                throw new ArgumentNullException("electronicMailTypeDescriptor is a required property for EdFiParentElectronicMail and cannot be null");
            }
            this.ElectronicMailTypeDescriptor = electronicMailTypeDescriptor;
            // to ensure "electronicMailAddress" is required (not null)
            if (electronicMailAddress == null)
            {
                throw new ArgumentNullException("electronicMailAddress is a required property for EdFiParentElectronicMail and cannot be null");
            }
