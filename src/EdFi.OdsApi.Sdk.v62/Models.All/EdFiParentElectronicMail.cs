...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    /// </summary>
    public partial class EdFiParentElectronicMail : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the ParentElectronicMail entity.</param>
        [JsonConstructor]
        public EdFiParentElectronicMail(string electronicMailTypeDescriptor, string electronicMailAddress, Option<bool?> doNotPublishIndicator = default, Option<bool?> primaryEmailAddressIndicator = default, Option<Object?> ext = default)
        {
        ...
        /// <summary>
        /// Extensions to the ParentElectronicMail entity.
        /// </summary>
        /// <value>Extensions to the ParentElectronicMail entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiParentElectronicMail" />
    /// </summary>
    public class EdFiParentElectronicMailJsonConverter : JsonConverter<EdFiParentElectronicMail>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiParentElectronicMail" />
        /// </summary>
        ...
        public override EdFiParentElectronicMail Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!electronicMailTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentElectronicMail.", nameof(electronicMailTypeDescriptor));

            if (!electronicMailAddress.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentElectronicMail.", nameof(electronicMailAddress));

            if (electronicMailTypeDescriptor.IsSet && electronicMailTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(electronicMailTypeDescriptor), "Property is not nullable for class EdFiParentElectronicMail.");

            if (electronicMailAddress.IsSet && electronicMailAddress.Value == null)
                throw new ArgumentNullException(nameof(electronicMailAddress), "Property is not nullable for class EdFiParentElectronicMail.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiParentElectronicMail.");

            return new EdFiParentElectronicMail(electronicMailTypeDescriptor.Value!, electronicMailAddress.Value!, doNotPublishIndicator, primaryEmailAddressIndicator, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiParentElectronicMail" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiParentElectronicMail"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiParentElectronicMail edFiParentElectronicMail, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiParentElectronicMail, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiParentElectronicMail" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiParentElectronicMail"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiParentElectronicMail edFiParentElectronicMail, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiParentElectronicMail.ElectronicMailTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiParentElectronicMail.ElectronicMailTypeDescriptor), "Property is required for class EdFiParentElectronicMail.");

            if (edFiParentElectronicMail.ElectronicMailAddress == null)
                throw new ArgumentNullException(nameof(edFiParentElectronicMail.ElectronicMailAddress), "Property is required for class EdFiParentElectronicMail.");

            if (edFiParentElectronicMail.ExtOption.IsSet && edFiParentElectronicMail.Ext == null)
                throw new ArgumentNullException(nameof(edFiParentElectronicMail.Ext), "Property is required for class EdFiParentElectronicMail.");

            writer.WriteString("electronicMailTypeDescriptor", edFiParentElectronicMail.ElectronicMailTypeDescriptor);

            writer.WriteString("electronicMailAddress", edFiParentElectronicMail.ElectronicMailAddress);

            if (edFiParentElectronicMail.DoNotPublishIndicatorOption.IsSet)
                if (edFiParentElectronicMail.DoNotPublishIndicatorOption.Value != null)
                    writer.WriteBoolean("doNotPublishIndicator", edFiParentElectronicMail.DoNotPublishIndicatorOption.Value!.Value);
                else
                    writer.WriteNull("doNotPublishIndicator");

            if (edFiParentElectronicMail.PrimaryEmailAddressIndicatorOption.IsSet)
                if (edFiParentElectronicMail.PrimaryEmailAddressIndicatorOption.Value != null)
                    writer.WriteBoolean("primaryEmailAddressIndicator", edFiParentElectronicMail.PrimaryEmailAddressIndicatorOption.Value!.Value);
                else
                    writer.WriteNull("primaryEmailAddressIndicator");

            if (edFiParentElectronicMail.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiParentElectronicMail.Ext, jsonSerializerOptions);
            }
        }
    }
}
