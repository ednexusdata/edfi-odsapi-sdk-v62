...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiCalendar : IValidatableObject
    {
        ...
        public EdFiCalendar(string id = default, string calendarCode = default, EdFiSchoolReference schoolReference = default, EdFiSchoolYearTypeReference schoolYearTypeReference = default, string calendarTypeDescriptor = default, List<EdFiCalendarGradeLevel> gradeLevels = default, string etag = default, Object ext = default)
        {
