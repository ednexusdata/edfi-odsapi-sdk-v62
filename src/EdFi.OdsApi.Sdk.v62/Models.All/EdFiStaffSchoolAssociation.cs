...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStaffSchoolAssociation : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiStaffSchoolAssociation(string programAssignmentDescriptor, EdFiSchoolReference schoolReference, EdFiStaffReference staffReference, Option<string?> id = default, Option<EdFiCalendarReference?> calendarReference = default, Option<EdFiSchoolYearTypeReference?> schoolYearTypeReference = default, Option<List<EdFiStaffSchoolAssociationAcademicSubject>?> academicSubjects = default, Option<List<EdFiStaffSchoolAssociationGradeLevel>?> gradeLevels = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiStaffSchoolAssociationJsonConverter : JsonConverter<EdFiStaffSchoolAssociation>
    {
        ...
        public override EdFiStaffSchoolAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiStaffSchoolAssociation(programAssignmentDescriptor.Value!, schoolReference.Value!, staffReference.Value!, id, calendarReference, schoolYearTypeReference, academicSubjects, gradeLevels, etag, ext);
        }
