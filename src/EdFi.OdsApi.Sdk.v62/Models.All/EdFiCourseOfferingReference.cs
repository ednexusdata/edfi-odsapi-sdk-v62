...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiCourseOfferingReference : IValidatableObject
    {
        ...
        public EdFiCourseOfferingReference(string localCourseCode = default, int schoolId = default, int schoolYear = default, string sessionName = default, Link link = default)
        {
