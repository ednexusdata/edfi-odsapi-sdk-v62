...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiGradeReference : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiGradeReference(DateOnly beginDate, string gradeTypeDescriptor, string gradingPeriodDescriptor, int gradingPeriodSchoolYear, int gradingPeriodSequence, string localCourseCode, int schoolId, int schoolYear, string sectionIdentifier, string sessionName, string studentUniqueId, Option<Link?> link = default)
        {
            BeginDate = beginDate;
    ...
    public class EdFiGradeReferenceJsonConverter : JsonConverter<EdFiGradeReference>
    {
        ...
        public override EdFiGradeReference Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!gradingPeriodSequence.IsSet)
                throw new ArgumentException("Property is required for class EdFiGradeReference.", nameof(gradingPeriodSequence));
            ...
            if (gradingPeriodSequence.IsSet && gradingPeriodSequence.Value == null)
                throw new ArgumentNullException(nameof(gradingPeriodSequence), "Property is not nullable for class EdFiGradeReference.");
            ...
            return new EdFiGradeReference(beginDate.Value!.Value!, gradeTypeDescriptor.Value!, gradingPeriodDescriptor.Value!, gradingPeriodSchoolYear.Value!.Value!, gradingPeriodSequence.Value!.Value!, localCourseCode.Value!, schoolId.Value!.Value!, schoolYear.Value!.Value!, sectionIdentifier.Value!, sessionName.Value!, studentUniqueId.Value!, link);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiGradeReference edFiGradeReference, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteNumber("gradingPeriodSequence", edFiGradeReference.GradingPeriodSequence);
