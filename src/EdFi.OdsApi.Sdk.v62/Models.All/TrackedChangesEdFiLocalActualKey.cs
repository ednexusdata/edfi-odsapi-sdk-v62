...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiLocalActualKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiLocalActualKey(DateOnly asOfDate = default, string accountIdentifier = default, int educationOrganizationId = default, int fiscalYear = default)
        {
