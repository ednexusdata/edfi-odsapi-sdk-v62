...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStaffSectionAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStaffSectionAssociationKey(string localCourseCode = default, int schoolId = default, int schoolYear = default, string sectionIdentifier = default, string sessionName = default, string staffUniqueId = default)
        {
