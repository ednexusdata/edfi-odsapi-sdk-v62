...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiFundDimension : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiFundDimension(string code, int fiscalYear, Option<string?> id = default, Option<string?> codeName = default, Option<List<EdFiFundDimensionReportingTag>?> reportingTags = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
            Code = code;
    ...
    public class EdFiFundDimensionJsonConverter : JsonConverter<EdFiFundDimension>
    {
        ...
        public override EdFiFundDimension Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiFundDimension(code.Value!, fiscalYear.Value!.Value!, id, codeName, reportingTags, etag, ext);
        }
