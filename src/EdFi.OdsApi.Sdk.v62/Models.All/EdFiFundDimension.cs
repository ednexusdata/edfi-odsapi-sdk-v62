...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiFundDimension : IValidatableObject
    {
        ...
        public EdFiFundDimension(string id = default, string code = default, int fiscalYear = default, string codeName = default, List<EdFiFundDimensionReportingTag> reportingTags = default, string etag = default, Object ext = default)
        {
