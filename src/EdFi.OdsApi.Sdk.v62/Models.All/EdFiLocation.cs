...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiLocation : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiLocation(string classroomIdentificationCode, EdFiSchoolReference schoolReference, Option<string?> id = default, Option<int?> maximumNumberOfSeats = default, Option<int?> optimalNumberOfSeats = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiLocationJsonConverter : JsonConverter<EdFiLocation>
    {
        ...
        public override EdFiLocation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiLocation(classroomIdentificationCode.Value!, schoolReference.Value!, id, maximumNumberOfSeats, optimalNumberOfSeats, etag, ext);
        }
