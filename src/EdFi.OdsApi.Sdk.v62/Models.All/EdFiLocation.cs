...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiLocation : IValidatableObject
    {
        ...
        public EdFiLocation(string id = default, string classroomIdentificationCode = default, EdFiSchoolReference schoolReference = default, int? maximumNumberOfSeats = default, int? optimalNumberOfSeats = default, string etag = default, Object ext = default)
        {
