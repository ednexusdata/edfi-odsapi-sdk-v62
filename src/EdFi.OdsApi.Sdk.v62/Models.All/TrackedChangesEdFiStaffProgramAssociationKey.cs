...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStaffProgramAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStaffProgramAssociationKey(DateOnly beginDate = default, int programEducationOrganizationId = default, string programName = default, string programTypeDescriptor = default, string staffUniqueId = default)
        {
