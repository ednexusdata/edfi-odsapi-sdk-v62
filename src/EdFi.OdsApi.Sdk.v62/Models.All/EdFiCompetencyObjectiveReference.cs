...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiCompetencyObjectiveReference : IValidatableObject
    {
        ...
        public EdFiCompetencyObjectiveReference(int educationOrganizationId = default, string objective = default, string objectiveGradeLevelDescriptor = default, Link link = default)
        {
