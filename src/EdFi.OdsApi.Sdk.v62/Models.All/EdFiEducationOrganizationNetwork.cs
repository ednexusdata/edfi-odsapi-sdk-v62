...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public class EdFiEducationOrganizationNetworkJsonConverter : JsonConverter<EdFiEducationOrganizationNetwork>
    {
        ...
        public override EdFiEducationOrganizationNetwork Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiEducationOrganizationNetwork(categories.Value!, educationOrganizationNetworkId.Value!.Value!, nameOfInstitution.Value!, networkPurposeDescriptor.Value!, id, addresses, identificationCodes, indicators, institutionTelephones, internationalAddresses, operationalStatusDescriptor, shortNameOfInstitution, webSite, etag, ext);
        }
