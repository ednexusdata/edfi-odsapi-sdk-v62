...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiEducationOrganizationNetwork : IValidatableObject
    {
        ...
        public EdFiEducationOrganizationNetwork(string id = default, List<EdFiEducationOrganizationCategory> categories = default, int educationOrganizationNetworkId = default, List<EdFiEducationOrganizationAddress> addresses = default, List<EdFiEducationOrganizationIdentificationCode> identificationCodes = default, List<EdFiEducationOrganizationIndicator> indicators = default, List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones = default, List<EdFiEducationOrganizationInternationalAddress> internationalAddresses = default, string nameOfInstitution = default, string networkPurposeDescriptor = default, string operationalStatusDescriptor = default, string shortNameOfInstitution = default, string webSite = default, string etag = default, Object ext = default)
        {
