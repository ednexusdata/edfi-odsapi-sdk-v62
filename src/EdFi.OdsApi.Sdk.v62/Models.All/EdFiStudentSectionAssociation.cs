...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentSectionAssociation : IValidatableObject
    {
        ...
        public EdFiStudentSectionAssociation(string id = default, DateOnly beginDate = default, EdFiSectionReference sectionReference = default, EdFiStudentReference studentReference = default, string attemptStatusDescriptor = default, DateOnly? endDate = default, bool? homeroomIndicator = default, string repeatIdentifierDescriptor = default, bool? teacherStudentDataLinkExclusion = default, string etag = default, Object ext = default)
        {
