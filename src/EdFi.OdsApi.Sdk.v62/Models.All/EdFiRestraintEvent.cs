...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiRestraintEvent : IValidatableObject
    {
        ...
        public EdFiRestraintEvent(string id = default, string restraintEventIdentifier = default, EdFiSchoolReference schoolReference = default, EdFiStudentReference studentReference = default, string educationalEnvironmentDescriptor = default, DateOnly eventDate = default, List<EdFiRestraintEventProgram> programs = default, List<EdFiRestraintEventReason> reasons = default, string etag = default, Object ext = default)
        {
