...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiReportCardReference : IValidatableObject
    {
        ...
        public EdFiReportCardReference(int educationOrganizationId = default, string gradingPeriodDescriptor = default, int gradingPeriodSchoolId = default, int gradingPeriodSchoolYear = default, int gradingPeriodSequence = default, string studentUniqueId = default, Link link = default)
        {
