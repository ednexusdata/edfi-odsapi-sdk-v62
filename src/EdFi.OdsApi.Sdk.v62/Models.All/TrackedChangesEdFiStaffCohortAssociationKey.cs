...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStaffCohortAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStaffCohortAssociationKey(DateOnly beginDate = default, string cohortIdentifier = default, int educationOrganizationId = default, string staffUniqueId = default)
        {
