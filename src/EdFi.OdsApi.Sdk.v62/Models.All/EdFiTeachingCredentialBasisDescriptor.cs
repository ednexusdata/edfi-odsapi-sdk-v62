...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiTeachingCredentialBasisDescriptor : IValidatableObject
    {
        ...
        public EdFiTeachingCredentialBasisDescriptor(string id = default, int teachingCredentialBasisDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
