...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiDescriptorMapping : IValidatableObject
    {
        ...
        public EdFiDescriptorMapping(string id = default, string mappedNamespace = default, string mappedValue = default, string varNamespace = default, string value = default, List<EdFiDescriptorMappingModelEntity> modelEntities = default, string etag = default, Object ext = default)
        {
