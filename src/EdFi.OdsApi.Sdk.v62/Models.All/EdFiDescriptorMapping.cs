...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiDescriptorMapping : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiDescriptorMapping(string mappedNamespace, string mappedValue, string @namespace, string value, Option<string?> id = default, Option<List<EdFiDescriptorMappingModelEntity>?> modelEntities = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiDescriptorMappingJsonConverter : JsonConverter<EdFiDescriptorMapping>
    {
        ...
        public override EdFiDescriptorMapping Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiDescriptorMapping(mappedNamespace.Value!, mappedValue.Value!, varNamespace.Value!, value.Value!, id, modelEntities, etag, ext);
        }
