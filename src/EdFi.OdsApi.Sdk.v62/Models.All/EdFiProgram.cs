...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiProgram : IValidatableObject
    {
        ...
        public EdFiProgram(string id = default, string programName = default, string programTypeDescriptor = default, EdFiEducationOrganizationReference educationOrganizationReference = default, List<EdFiProgramCharacteristic> characteristics = default, List<EdFiProgramLearningObjective> learningObjectives = default, List<EdFiProgramLearningStandard> learningStandards = default, string programId = default, List<EdFiProgramService> services = default, List<EdFiProgramSponsor> sponsors = default, string etag = default, Object ext = default)
        {
