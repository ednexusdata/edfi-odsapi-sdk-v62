...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiProgram : IValidatableObject
    {
        ...
        /// <param name="learningObjectives">An unordered collection of programLearningObjectives. References the learning objective(s) with which the program is associated.</param>
        ...
        [JsonConstructor]
        public EdFiProgram(string programName, string programTypeDescriptor, EdFiEducationOrganizationReference educationOrganizationReference, Option<string?> id = default, Option<List<EdFiProgramCharacteristic>?> characteristics = default, Option<List<EdFiProgramLearningObjective>?> learningObjectives = default, Option<List<EdFiProgramLearningStandard>?> learningStandards = default, Option<string?> programId = default, Option<List<EdFiProgramService>?> services = default, Option<List<EdFiProgramSponsor>?> sponsors = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiProgramLearningObjective>?> LearningObjectivesOption { get; private set; }

        /// <summary>
        /// An unordered collection of programLearningObjectives. References the learning objective(s) with which the program is associated.
        /// </summary>
        /// <value>An unordered collection of programLearningObjectives. References the learning objective(s) with which the program is associated.</value>
        [JsonPropertyName("learningObjectives")]
        public List<EdFiProgramLearningObjective>? LearningObjectives { get { return this.LearningObjectivesOption; } set { this.LearningObjectivesOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiProgramService>?> ServicesOption { get; private set; }
        ...
        public List<EdFiProgramService>? Services { get { return this.ServicesOption; } set { this.ServicesOption = new(value); } }
    ...
    public class EdFiProgramJsonConverter : JsonConverter<EdFiProgram>
    {
        ...
        public override EdFiProgram Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EdFiProgramLearningObjective>?> learningObjectives = default;
            Option<List<EdFiProgramLearningStandard>?> learningStandards = default;
            Option<string?> programId = default;
            Option<List<EdFiProgramService>?> services = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "learningObjectives":
                            learningObjectives = new Option<List<EdFiProgramLearningObjective>?>(JsonSerializer.Deserialize<List<EdFiProgramLearningObjective>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        ...
                        case "programId":
                            ...
                            break;
                        case "services":
                            services = new Option<List<EdFiProgramService>?>(JsonSerializer.Deserialize<List<EdFiProgramService>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "sponsors":
            ...
            if (learningObjectives.IsSet && learningObjectives.Value == null)
                throw new ArgumentNullException(nameof(learningObjectives), "Property is not nullable for class EdFiProgram.");
            ...
            if (services.IsSet && services.Value == null)
                throw new ArgumentNullException(nameof(services), "Property is not nullable for class EdFiProgram.");
            ...
            return new EdFiProgram(programName.Value!, programTypeDescriptor.Value!, educationOrganizationReference.Value!, id, characteristics, learningObjectives, learningStandards, programId, services, sponsors, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiProgram edFiProgram, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiProgram.LearningObjectivesOption.IsSet && edFiProgram.LearningObjectives == null)
                throw new ArgumentNullException(nameof(edFiProgram.LearningObjectives), "Property is required for class EdFiProgram.");
            ...
            if (edFiProgram.ServicesOption.IsSet && edFiProgram.Services == null)
                throw new ArgumentNullException(nameof(edFiProgram.Services), "Property is required for class EdFiProgram.");
            ...
            if (edFiProgram.LearningObjectivesOption.IsSet)
            {
                writer.WritePropertyName("learningObjectives");
                JsonSerializer.Serialize(writer, edFiProgram.LearningObjectives, jsonSerializerOptions);
            }
            ...
            if (edFiProgram.ServicesOption.IsSet)
            {
                writer.WritePropertyName("services");
                JsonSerializer.Serialize(writer, edFiProgram.Services, jsonSerializerOptions);
            }
