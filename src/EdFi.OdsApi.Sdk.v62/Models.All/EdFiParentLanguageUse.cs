...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiParentLanguageUse : IValidatableObject
    {
        ...
        public EdFiParentLanguageUse(string languageUseDescriptor = default, Object ext = default)
        {
            // to ensure "languageUseDescriptor" is required (not null)
            if (languageUseDescriptor == null)
            {
                throw new ArgumentNullException("languageUseDescriptor is a required property for EdFiParentLanguageUse and cannot be null");
            }
