...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiSchoolYearType : IValidatableObject
    {
        ...
        public EdFiSchoolYearType(string id = default, int schoolYear = default, bool currentSchoolYear = default, string schoolYearDescription = default, string etag = default, Object ext = default)
        {
