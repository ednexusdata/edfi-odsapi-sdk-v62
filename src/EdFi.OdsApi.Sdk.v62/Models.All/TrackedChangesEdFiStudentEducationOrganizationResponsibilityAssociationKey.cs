...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey(Option<string?> responsibilityDescriptor = default, Option<DateOnly?> beginDate = default, Option<int?> educationOrganizationId = default, Option<string?> studentUniqueId = default)
        {
