...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey(string responsibilityDescriptor = default, DateOnly beginDate = default, int educationOrganizationId = default, string studentUniqueId = default)
        {
