...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiParentPersonalIdentificationDocument : IValidatableObject
    {
        ...
        public EdFiParentPersonalIdentificationDocument(string identificationDocumentUseDescriptor = default, string personalInformationVerificationDescriptor = default, string issuerCountryDescriptor = default, DateOnly? documentExpirationDate = default, string documentTitle = default, string issuerDocumentIdentificationCode = default, string issuerName = default, Object ext = default)
        {
            ...
            {
                throw new ArgumentNullException("identificationDocumentUseDescriptor is a required property for EdFiParentPersonalIdentificationDocument and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("personalInformationVerificationDescriptor is a required property for EdFiParentPersonalIdentificationDocument and cannot be null");
            }
