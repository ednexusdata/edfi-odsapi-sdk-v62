...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    /// </summary>
    public partial class EdFiParentPersonalIdentificationDocument : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the ParentPersonalIdentificationDocument entity.</param>
        [JsonConstructor]
        ...
        /// <summary>
        /// Extensions to the ParentPersonalIdentificationDocument entity.
        /// </summary>
        /// <value>Extensions to the ParentPersonalIdentificationDocument entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiParentPersonalIdentificationDocument" />
    /// </summary>
    public class EdFiParentPersonalIdentificationDocumentJsonConverter : JsonConverter<EdFiParentPersonalIdentificationDocument>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EdFiParentPersonalIdentificationDocument" />
        /// </summary>
        ...
        public override EdFiParentPersonalIdentificationDocument Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!identificationDocumentUseDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentPersonalIdentificationDocument.", nameof(identificationDocumentUseDescriptor));

            if (!personalInformationVerificationDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentPersonalIdentificationDocument.", nameof(personalInformationVerificationDescriptor));

            if (identificationDocumentUseDescriptor.IsSet && identificationDocumentUseDescriptor.Value == null)
                throw new ArgumentNullException(nameof(identificationDocumentUseDescriptor), "Property is not nullable for class EdFiParentPersonalIdentificationDocument.");

            if (personalInformationVerificationDescriptor.IsSet && personalInformationVerificationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(personalInformationVerificationDescriptor), "Property is not nullable for class EdFiParentPersonalIdentificationDocument.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiParentPersonalIdentificationDocument.");

            return new EdFiParentPersonalIdentificationDocument(identificationDocumentUseDescriptor.Value!, personalInformationVerificationDescriptor.Value!, issuerCountryDescriptor, documentExpirationDate, documentTitle, issuerDocumentIdentificationCode, issuerName, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiParentPersonalIdentificationDocument" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiParentPersonalIdentificationDocument"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiParentPersonalIdentificationDocument edFiParentPersonalIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiParentPersonalIdentificationDocument, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiParentPersonalIdentificationDocument" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiParentPersonalIdentificationDocument"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiParentPersonalIdentificationDocument edFiParentPersonalIdentificationDocument, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiParentPersonalIdentificationDocument.IdentificationDocumentUseDescriptor == null)
                throw new ArgumentNullException(nameof(edFiParentPersonalIdentificationDocument.IdentificationDocumentUseDescriptor), "Property is required for class EdFiParentPersonalIdentificationDocument.");

            if (edFiParentPersonalIdentificationDocument.PersonalInformationVerificationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiParentPersonalIdentificationDocument.PersonalInformationVerificationDescriptor), "Property is required for class EdFiParentPersonalIdentificationDocument.");

            if (edFiParentPersonalIdentificationDocument.ExtOption.IsSet && edFiParentPersonalIdentificationDocument.Ext == null)
                throw new ArgumentNullException(nameof(edFiParentPersonalIdentificationDocument.Ext), "Property is required for class EdFiParentPersonalIdentificationDocument.");

            writer.WriteString("identificationDocumentUseDescriptor", edFiParentPersonalIdentificationDocument.IdentificationDocumentUseDescriptor);

            writer.WriteString("personalInformationVerificationDescriptor", edFiParentPersonalIdentificationDocument.PersonalInformationVerificationDescriptor);

            if (edFiParentPersonalIdentificationDocument.IssuerCountryDescriptorOption.IsSet)
                if (edFiParentPersonalIdentificationDocument.IssuerCountryDescriptorOption.Value != null)
                    writer.WriteString("issuerCountryDescriptor", edFiParentPersonalIdentificationDocument.IssuerCountryDescriptor);
                else
                    writer.WriteNull("issuerCountryDescriptor");

            if (edFiParentPersonalIdentificationDocument.DocumentExpirationDateOption.IsSet)
                if (edFiParentPersonalIdentificationDocument.DocumentExpirationDateOption.Value != null)
                    writer.WriteString("documentExpirationDate", edFiParentPersonalIdentificationDocument.DocumentExpirationDateOption.Value!.Value.ToString(DocumentExpirationDateFormat));
                else
                    writer.WriteNull("documentExpirationDate");

            if (edFiParentPersonalIdentificationDocument.DocumentTitleOption.IsSet)
                if (edFiParentPersonalIdentificationDocument.DocumentTitleOption.Value != null)
                    writer.WriteString("documentTitle", edFiParentPersonalIdentificationDocument.DocumentTitle);
                else
                    writer.WriteNull("documentTitle");

            if (edFiParentPersonalIdentificationDocument.IssuerDocumentIdentificationCodeOption.IsSet)
                if (edFiParentPersonalIdentificationDocument.IssuerDocumentIdentificationCodeOption.Value != null)
                    writer.WriteString("issuerDocumentIdentificationCode", edFiParentPersonalIdentificationDocument.IssuerDocumentIdentificationCode);
                else
                    writer.WriteNull("issuerDocumentIdentificationCode");

            if (edFiParentPersonalIdentificationDocument.IssuerNameOption.IsSet)
                if (edFiParentPersonalIdentificationDocument.IssuerNameOption.Value != null)
                    writer.WriteString("issuerName", edFiParentPersonalIdentificationDocument.IssuerName);
                else
                    writer.WriteNull("issuerName");

            if (edFiParentPersonalIdentificationDocument.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiParentPersonalIdentificationDocument.Ext, jsonSerializerOptions);
            }
        }
    }
}
