...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStaff : IValidatableObject
    {
        ...
        public EdFiStaff(string id = default, string staffUniqueId = default, EdFiPersonReference personReference = default, List<EdFiStaffAddress> addresses = default, List<EdFiStaffAncestryEthnicOrigin> ancestryEthnicOrigins = default, DateOnly? birthDate = default, string citizenshipStatusDescriptor = default, List<EdFiStaffCredential> credentials = default, List<EdFiStaffElectronicMail> electronicMails = default, string firstName = default, string generationCodeSuffix = default, string highestCompletedLevelOfEducationDescriptor = default, bool? highlyQualifiedTeacher = default, bool? hispanicLatinoEthnicity = default, List<EdFiStaffIdentificationCode> identificationCodes = default, List<EdFiStaffIdentificationDocument> identificationDocuments = default, List<EdFiStaffInternationalAddress> internationalAddresses = default, List<EdFiStaffLanguage> languages = default, string lastSurname = default, string loginId = default, string maidenName = default, string middleName = default, string oldEthnicityDescriptor = default, List<EdFiStaffOtherName> otherNames = default, List<EdFiStaffPersonalIdentificationDocument> personalIdentificationDocuments = default, string personalTitlePrefix = default, List<EdFiStaffRace> races = default, List<EdFiStaffRecognition> recognitions = default, string sexDescriptor = default, List<EdFiStaffTelephone> telephones = default, List<EdFiStaffTribalAffiliation> tribalAffiliations = default, List<EdFiStaffVisa> visas = default, double? yearsOfPriorProfessionalExperience = default, double? yearsOfPriorTeachingExperience = default, string etag = default, Object ext = default)
        {
        ...
        [DataMember(Name = "oldEthnicityDescriptor", EmitDefaultValue = true)]
