...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiLocalContractedStaffKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiLocalContractedStaffKey(DateOnly asOfDate = default, string accountIdentifier = default, int educationOrganizationId = default, int fiscalYear = default, string staffUniqueId = default)
        {
