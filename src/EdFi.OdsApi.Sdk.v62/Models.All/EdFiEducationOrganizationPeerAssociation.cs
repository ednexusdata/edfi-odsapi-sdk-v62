...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiEducationOrganizationPeerAssociation : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiEducationOrganizationPeerAssociation(EdFiEducationOrganizationReference educationOrganizationReference, EdFiEducationOrganizationReference peerEducationOrganizationReference, Option<string?> id = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiEducationOrganizationPeerAssociationJsonConverter : JsonConverter<EdFiEducationOrganizationPeerAssociation>
    {
        ...
        public override EdFiEducationOrganizationPeerAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiEducationOrganizationPeerAssociation(educationOrganizationReference.Value!, peerEducationOrganizationReference.Value!, id, etag, ext);
        }
