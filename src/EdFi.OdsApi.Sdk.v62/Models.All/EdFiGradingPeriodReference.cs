...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiGradingPeriodReference : IValidatableObject
    {
        ...
        public EdFiGradingPeriodReference(string gradingPeriodDescriptor = default, int periodSequence = default, int schoolId = default, int schoolYear = default, Link link = default)
        {
