...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    /// EdFiParentOtherName
    /// </summary>
    public partial class EdFiParentOtherName : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the ParentOtherName entity.</param>
        [JsonConstructor]
        public EdFiParentOtherName(string otherNameTypeDescriptor, string firstName, string lastSurname, Option<string?> generationCodeSuffix = default, Option<string?> middleName = default, Option<string?> personalTitlePrefix = default, Option<Object?> ext = default)
        {
        ...
        /// <summary>
        /// Extensions to the ParentOtherName entity.
        /// </summary>
        /// <value>Extensions to the ParentOtherName entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiParentOtherName" />
    /// </summary>
    public class EdFiParentOtherNameJsonConverter : JsonConverter<EdFiParentOtherName>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiParentOtherName" />
        /// </summary>
        ...
        public override EdFiParentOtherName Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!otherNameTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentOtherName.", nameof(otherNameTypeDescriptor));

            if (!firstName.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentOtherName.", nameof(firstName));

            if (!lastSurname.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentOtherName.", nameof(lastSurname));

            if (otherNameTypeDescriptor.IsSet && otherNameTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(otherNameTypeDescriptor), "Property is not nullable for class EdFiParentOtherName.");

            if (firstName.IsSet && firstName.Value == null)
                throw new ArgumentNullException(nameof(firstName), "Property is not nullable for class EdFiParentOtherName.");

            if (lastSurname.IsSet && lastSurname.Value == null)
                throw new ArgumentNullException(nameof(lastSurname), "Property is not nullable for class EdFiParentOtherName.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiParentOtherName.");

            return new EdFiParentOtherName(otherNameTypeDescriptor.Value!, firstName.Value!, lastSurname.Value!, generationCodeSuffix, middleName, personalTitlePrefix, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiParentOtherName" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiParentOtherName"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiParentOtherName edFiParentOtherName, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiParentOtherName, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiParentOtherName" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiParentOtherName"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiParentOtherName edFiParentOtherName, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiParentOtherName.OtherNameTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiParentOtherName.OtherNameTypeDescriptor), "Property is required for class EdFiParentOtherName.");

            if (edFiParentOtherName.FirstName == null)
                throw new ArgumentNullException(nameof(edFiParentOtherName.FirstName), "Property is required for class EdFiParentOtherName.");

            if (edFiParentOtherName.LastSurname == null)
                throw new ArgumentNullException(nameof(edFiParentOtherName.LastSurname), "Property is required for class EdFiParentOtherName.");

            if (edFiParentOtherName.ExtOption.IsSet && edFiParentOtherName.Ext == null)
                throw new ArgumentNullException(nameof(edFiParentOtherName.Ext), "Property is required for class EdFiParentOtherName.");

            writer.WriteString("otherNameTypeDescriptor", edFiParentOtherName.OtherNameTypeDescriptor);

            writer.WriteString("firstName", edFiParentOtherName.FirstName);

            writer.WriteString("lastSurname", edFiParentOtherName.LastSurname);

            if (edFiParentOtherName.GenerationCodeSuffixOption.IsSet)
                if (edFiParentOtherName.GenerationCodeSuffixOption.Value != null)
                    writer.WriteString("generationCodeSuffix", edFiParentOtherName.GenerationCodeSuffix);
                else
                    writer.WriteNull("generationCodeSuffix");

            if (edFiParentOtherName.MiddleNameOption.IsSet)
                if (edFiParentOtherName.MiddleNameOption.Value != null)
                    writer.WriteString("middleName", edFiParentOtherName.MiddleName);
                else
                    writer.WriteNull("middleName");

            if (edFiParentOtherName.PersonalTitlePrefixOption.IsSet)
                if (edFiParentOtherName.PersonalTitlePrefixOption.Value != null)
                    writer.WriteString("personalTitlePrefix", edFiParentOtherName.PersonalTitlePrefix);
                else
                    writer.WriteNull("personalTitlePrefix");

            if (edFiParentOtherName.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiParentOtherName.Ext, jsonSerializerOptions);
            }
        }
    }
}
