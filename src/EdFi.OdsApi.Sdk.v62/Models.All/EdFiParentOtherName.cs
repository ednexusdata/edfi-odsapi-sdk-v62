...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiParentOtherName : IValidatableObject
    {
        ...
        public EdFiParentOtherName(string otherNameTypeDescriptor = default, string firstName = default, string generationCodeSuffix = default, string lastSurname = default, string middleName = default, string personalTitlePrefix = default, Object ext = default)
        {
            // to ensure "otherNameTypeDescriptor" is required (not null)
            if (otherNameTypeDescriptor == null)
            {
                throw new ArgumentNullException("otherNameTypeDescriptor is a required property for EdFiParentOtherName and cannot be null");
            }
            this.OtherNameTypeDescriptor = otherNameTypeDescriptor;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for EdFiParentOtherName and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastSurname" is required (not null)
            if (lastSurname == null)
            {
                throw new ArgumentNullException("lastSurname is a required property for EdFiParentOtherName and cannot be null");
            }
