...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public class EdFiStudentInterventionAttendanceEventJsonConverter : JsonConverter<EdFiStudentInterventionAttendanceEvent>
    {
        ...
        public override EdFiStudentInterventionAttendanceEvent Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiStudentInterventionAttendanceEvent(attendanceEventCategoryDescriptor.Value!, eventDate.Value!.Value!, interventionReference.Value!, studentReference.Value!, id, attendanceEventReason, educationalEnvironmentDescriptor, eventDuration, interventionDuration, etag, ext);
        }
