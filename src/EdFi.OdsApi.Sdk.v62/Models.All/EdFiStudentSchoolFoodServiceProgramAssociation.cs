...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentSchoolFoodServiceProgramAssociation : IValidatableObject
    {
        ...
        public EdFiStudentSchoolFoodServiceProgramAssociation(string id = default, DateOnly beginDate = default, EdFiEducationOrganizationReference educationOrganizationReference = default, EdFiProgramReference programReference = default, EdFiStudentReference studentReference = default, bool? directCertification = default, DateOnly? endDate = default, EdFiGeneralStudentProgramAssociationParticipationStatus participationStatus = default, List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default, string reasonExitedDescriptor = default, List<EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramService> schoolFoodServiceProgramServices = default, bool? servedOutsideOfRegularSession = default, string etag = default, Object ext = default)
        {
