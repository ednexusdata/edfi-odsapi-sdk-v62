...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiHomelessPrimaryNighttimeResidenceDescriptor : IValidatableObject
    {
        ...
        public EdFiHomelessPrimaryNighttimeResidenceDescriptor(string id = default, int homelessPrimaryNighttimeResidenceDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
