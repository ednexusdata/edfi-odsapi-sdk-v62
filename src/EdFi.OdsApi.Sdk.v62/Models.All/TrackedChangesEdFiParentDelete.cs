...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_parentDelete")]
    public partial class TrackedChangesEdFiParentDelete : IValidatableObject
    {
        ...
        public TrackedChangesEdFiParentDelete(string id = default, decimal changeVersion = default, TrackedChangesEdFiParentKey keyValues = default)
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiParentKey KeyValues { get; set; }
