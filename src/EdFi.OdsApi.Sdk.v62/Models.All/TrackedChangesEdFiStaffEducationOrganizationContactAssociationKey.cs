...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStaffEducationOrganizationContactAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStaffEducationOrganizationContactAssociationKey(string contactTitle = default, int educationOrganizationId = default, string staffUniqueId = default)
        {
