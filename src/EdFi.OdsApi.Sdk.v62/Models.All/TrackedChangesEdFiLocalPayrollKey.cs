...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiLocalPayrollKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiLocalPayrollKey(DateOnly asOfDate = default, string accountIdentifier = default, int educationOrganizationId = default, int fiscalYear = default, string staffUniqueId = default)
        {
