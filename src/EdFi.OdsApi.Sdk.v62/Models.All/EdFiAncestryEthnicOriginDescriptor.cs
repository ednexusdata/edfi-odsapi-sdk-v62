...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiAncestryEthnicOriginDescriptor : IValidatableObject
    {
        ...
        public EdFiAncestryEthnicOriginDescriptor(string id = default, int ancestryEthnicOriginDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
