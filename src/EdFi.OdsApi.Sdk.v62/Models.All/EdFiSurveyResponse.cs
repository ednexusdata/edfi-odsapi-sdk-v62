...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiSurveyResponse : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track the state of ParentReference
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<EdFiParentReference?> ParentReferenceOption { get; private set; }

        /// <summary>
        /// Gets or Sets ParentReference
        /// </summary>
        [JsonPropertyName("parentReference")]
        public EdFiParentReference? ParentReference { get { return this.ParentReferenceOption; } set { this.ParentReferenceOption = new(value); } }
    ...
    public class EdFiSurveyResponseJsonConverter : JsonConverter<EdFiSurveyResponse>
    {
        ...
        public override EdFiSurveyResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (parentReference.IsSet && parentReference.Value == null)
                throw new ArgumentNullException(nameof(parentReference), "Property is not nullable for class EdFiSurveyResponse.");
            ...
            return new EdFiSurveyResponse(surveyResponseIdentifier.Value!, surveyReference.Value!, responseDate.Value!.Value!, id, parentReference, staffReference, studentReference, electronicMailAddress, fullName, location, responseTime, surveyLevels, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiSurveyResponse edFiSurveyResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiSurveyResponse.ParentReferenceOption.IsSet && edFiSurveyResponse.ParentReference == null)
                throw new ArgumentNullException(nameof(edFiSurveyResponse.ParentReference), "Property is required for class EdFiSurveyResponse.");
            ...
            if (edFiSurveyResponse.ParentReferenceOption.IsSet)
            {
                writer.WritePropertyName("parentReference");
                JsonSerializer.Serialize(writer, edFiSurveyResponse.ParentReference, jsonSerializerOptions);
            }
