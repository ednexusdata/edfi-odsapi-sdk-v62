...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentParentAssociation : IValidatableObject
    {
        ...
        public EdFiStudentParentAssociation(string id = default, EdFiParentReference parentReference = default, EdFiStudentReference studentReference = default, int? contactPriority = default, string contactRestrictions = default, bool? emergencyContactStatus = default, bool? legalGuardian = default, bool? livesWith = default, bool? primaryContactStatus = default, string relationDescriptor = default, string etag = default, Object ext = default)
        {
            // to ensure "parentReference" is required (not null)
            if (parentReference == null)
            {
                throw new ArgumentNullException("parentReference is a required property for EdFiStudentParentAssociation and cannot be null");
            }
            this.ParentReference = parentReference;
            // to ensure "studentReference" is required (not null)
            if (studentReference == null)
            {
                throw new ArgumentNullException("studentReference is a required property for EdFiStudentParentAssociation and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "parentReference", IsRequired = true, EmitDefaultValue = true)]
