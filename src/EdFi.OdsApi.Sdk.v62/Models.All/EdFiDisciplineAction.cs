...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiDisciplineAction : IValidatableObject
    {
        ...
        /// <param name="studentDisciplineIncidentAssociations">An unordered collection of disciplineActionStudentDisciplineIncidentAssociations. Reference to the discipline incident associated with the discipline action.</param>
        ...
        [JsonConstructor]
        public EdFiDisciplineAction(string disciplineActionIdentifier, DateOnly disciplineDate, List<EdFiDisciplineActionDiscipline> disciplines, EdFiSchoolReference responsibilitySchoolReference, EdFiStudentReference studentReference, Option<string?> id = default, Option<EdFiSchoolReference?> assignmentSchoolReference = default, Option<double?> actualDisciplineActionLength = default, Option<double?> disciplineActionLength = default, Option<string?> disciplineActionLengthDifferenceReasonDescriptor = default, Option<bool?> iepPlacementMeetingIndicator = default, Option<bool?> receivedEducationServicesDuringExpulsion = default, Option<bool?> relatedToZeroTolerancePolicy = default, Option<List<EdFiDisciplineActionStaff>?> staffs = default, Option<List<EdFiDisciplineActionStudentDisciplineIncidentAssociation>?> studentDisciplineIncidentAssociations = default, Option<List<EdFiDisciplineActionStudentDisciplineIncidentBehaviorAssociation>?> studentDisciplineIncidentBehaviorAssociations = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
            ...
            ReceivedEducationServicesDuringExpulsionOption = receivedEducationServicesDuringExpulsion;
            RelatedToZeroTolerancePolicyOption = relatedToZeroTolerancePolicy;
            StaffsOption = staffs;
            StudentDisciplineIncidentAssociationsOption = studentDisciplineIncidentAssociations;
        ...
        /// <summary>
        /// Used to track the state of ReceivedEducationServicesDuringExpulsion
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> ReceivedEducationServicesDuringExpulsionOption { get; private set; }
        ...
        [JsonPropertyName("receivedEducationServicesDuringExpulsion")]
        public bool? ReceivedEducationServicesDuringExpulsion { get { return this.ReceivedEducationServicesDuringExpulsionOption; } set { this.ReceivedEducationServicesDuringExpulsionOption = new(value); } }
        ...
        /// <summary>
        /// Used to track the state of StudentDisciplineIncidentAssociations
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiDisciplineActionStudentDisciplineIncidentAssociation>?> StudentDisciplineIncidentAssociationsOption { get; private set; }

        /// <summary>
        /// An unordered collection of disciplineActionStudentDisciplineIncidentAssociations. Reference to the discipline incident associated with the discipline action.
        /// </summary>
        /// <value>An unordered collection of disciplineActionStudentDisciplineIncidentAssociations. Reference to the discipline incident associated with the discipline action.</value>
        [JsonPropertyName("studentDisciplineIncidentAssociations")]
        public List<EdFiDisciplineActionStudentDisciplineIncidentAssociation>? StudentDisciplineIncidentAssociations { get { return this.StudentDisciplineIncidentAssociationsOption; } set { this.StudentDisciplineIncidentAssociationsOption = new(value); } }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for DisciplineActionIdentifier, length must be less than 32.", new [] { "DisciplineActionIdentifier" });
            }
    ...
    public class EdFiDisciplineActionJsonConverter : JsonConverter<EdFiDisciplineAction>
    {
        ...
        public override EdFiDisciplineAction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<bool?> receivedEducationServicesDuringExpulsion = default;
            Option<bool?> relatedToZeroTolerancePolicy = default;
            Option<List<EdFiDisciplineActionStaff>?> staffs = default;
            Option<List<EdFiDisciplineActionStudentDisciplineIncidentAssociation>?> studentDisciplineIncidentAssociations = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "receivedEducationServicesDuringExpulsion":
                            receivedEducationServicesDuringExpulsion = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        ...
                        case "staffs":
                            ...
                            break;
                        case "studentDisciplineIncidentAssociations":
                            studentDisciplineIncidentAssociations = new Option<List<EdFiDisciplineActionStudentDisciplineIncidentAssociation>?>(JsonSerializer.Deserialize<List<EdFiDisciplineActionStudentDisciplineIncidentAssociation>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
            ...
            if (studentDisciplineIncidentAssociations.IsSet && studentDisciplineIncidentAssociations.Value == null)
                throw new ArgumentNullException(nameof(studentDisciplineIncidentAssociations), "Property is not nullable for class EdFiDisciplineAction.");
            ...
            return new EdFiDisciplineAction(disciplineActionIdentifier.Value!, disciplineDate.Value!.Value!, disciplines.Value!, responsibilitySchoolReference.Value!, studentReference.Value!, id, assignmentSchoolReference, actualDisciplineActionLength, disciplineActionLength, disciplineActionLengthDifferenceReasonDescriptor, iepPlacementMeetingIndicator, receivedEducationServicesDuringExpulsion, relatedToZeroTolerancePolicy, staffs, studentDisciplineIncidentAssociations, studentDisciplineIncidentBehaviorAssociations, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiDisciplineAction edFiDisciplineAction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiDisciplineAction.StudentDisciplineIncidentAssociationsOption.IsSet && edFiDisciplineAction.StudentDisciplineIncidentAssociations == null)
                throw new ArgumentNullException(nameof(edFiDisciplineAction.StudentDisciplineIncidentAssociations), "Property is required for class EdFiDisciplineAction.");
            ...
            if (edFiDisciplineAction.ReceivedEducationServicesDuringExpulsionOption.IsSet)
                if (edFiDisciplineAction.ReceivedEducationServicesDuringExpulsionOption.Value != null)
                    writer.WriteBoolean("receivedEducationServicesDuringExpulsion", edFiDisciplineAction.ReceivedEducationServicesDuringExpulsionOption.Value!.Value);
                else
                    writer.WriteNull("receivedEducationServicesDuringExpulsion");
            ...
            if (edFiDisciplineAction.StudentDisciplineIncidentAssociationsOption.IsSet)
            {
                writer.WritePropertyName("studentDisciplineIncidentAssociations");
                JsonSerializer.Serialize(writer, edFiDisciplineAction.StudentDisciplineIncidentAssociations, jsonSerializerOptions);
            }
