...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiTechnicalSkillsAssessmentDescriptor : IValidatableObject
    {
        ...
        public EdFiTechnicalSkillsAssessmentDescriptor(string id = default, int technicalSkillsAssessmentDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
