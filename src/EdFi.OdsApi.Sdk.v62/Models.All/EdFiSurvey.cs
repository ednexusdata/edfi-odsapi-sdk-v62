...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiSurvey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiSurvey(string @namespace, string surveyIdentifier, EdFiSchoolYearTypeReference schoolYearTypeReference, string surveyTitle, Option<string?> id = default, Option<EdFiEducationOrganizationReference?> educationOrganizationReference = default, Option<EdFiSessionReference?> sessionReference = default, Option<int?> numberAdministered = default, Option<string?> surveyCategoryDescriptor = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
            Namespace = @namespace;
    ...
    public class EdFiSurveyJsonConverter : JsonConverter<EdFiSurvey>
    {
        ...
        public override EdFiSurvey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiSurvey(varNamespace.Value!, surveyIdentifier.Value!, schoolYearTypeReference.Value!, surveyTitle.Value!, id, educationOrganizationReference, sessionReference, numberAdministered, surveyCategoryDescriptor, etag, ext);
        }
