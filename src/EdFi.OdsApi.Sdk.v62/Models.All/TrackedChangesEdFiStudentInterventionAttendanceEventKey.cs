...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentInterventionAttendanceEventKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentInterventionAttendanceEventKey(string attendanceEventCategoryDescriptor = default, DateOnly eventDate = default, int educationOrganizationId = default, string interventionIdentificationCode = default, string studentUniqueId = default)
        {
