...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentInterventionAttendanceEventKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiStudentInterventionAttendanceEventKey(Option<string?> attendanceEventCategoryDescriptor = default, Option<DateOnly?> eventDate = default, Option<int?> educationOrganizationId = default, Option<string?> interventionIdentificationCode = default, Option<string?> studentUniqueId = default)
        {
