...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiCommunityOrganizationKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiCommunityOrganizationKey(Option<int?> communityOrganizationId = default)
        {
        ...
        public Option<int?> CommunityOrganizationIdOption { get; private set; }
        ...
        public int? CommunityOrganizationId { get { return this.CommunityOrganizationIdOption; } set { this.CommunityOrganizationIdOption = new(value); } }
