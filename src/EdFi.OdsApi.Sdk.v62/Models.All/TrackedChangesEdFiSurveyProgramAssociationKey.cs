...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveyProgramAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiSurveyProgramAssociationKey(int educationOrganizationId = default, string programName = default, string programTypeDescriptor = default, string varNamespace = default, string surveyIdentifier = default)
        {
