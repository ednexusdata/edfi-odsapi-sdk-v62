...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentDisciplineIncidentAssociationBehavior : IValidatableObject
    {
        ...
        public EdFiStudentDisciplineIncidentAssociationBehavior(string behaviorDescriptor = default, string behaviorDetailedDescription = default, Object ext = default)
        {
            // to ensure "behaviorDescriptor" is required (not null)
            if (behaviorDescriptor == null)
            {
                throw new ArgumentNullException("behaviorDescriptor is a required property for EdFiStudentDisciplineIncidentAssociationBehavior and cannot be null");
            }
