...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiGraduationPlanReference : IValidatableObject
    {
        ...
        public EdFiGraduationPlanReference(int educationOrganizationId = default, string graduationPlanTypeDescriptor = default, int graduationSchoolYear = default, Link link = default)
        {
