...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiCommunityProviderLicense : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiCommunityProviderLicense(string licenseIdentifier, string licensingOrganization, EdFiCommunityProviderReference communityProviderReference, DateOnly licenseEffectiveDate, string licenseTypeDescriptor, Option<string?> id = default, Option<int?> authorizedFacilityCapacity = default, Option<DateOnly?> licenseExpirationDate = default, Option<DateOnly?> licenseIssueDate = default, Option<string?> licenseStatusDescriptor = default, Option<int?> oldestAgeAuthorizedToServe = default, Option<int?> youngestAgeAuthorizedToServe = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for LicenseIdentifier, length must be less than 20.", new [] { "LicenseIdentifier" });
            }
    ...
    public class EdFiCommunityProviderLicenseJsonConverter : JsonConverter<EdFiCommunityProviderLicense>
    {
        ...
        public override EdFiCommunityProviderLicense Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiCommunityProviderLicense(licenseIdentifier.Value!, licensingOrganization.Value!, communityProviderReference.Value!, licenseEffectiveDate.Value!.Value!, licenseTypeDescriptor.Value!, id, authorizedFacilityCapacity, licenseExpirationDate, licenseIssueDate, licenseStatusDescriptor, oldestAgeAuthorizedToServe, youngestAgeAuthorizedToServe, etag, ext);
        }
