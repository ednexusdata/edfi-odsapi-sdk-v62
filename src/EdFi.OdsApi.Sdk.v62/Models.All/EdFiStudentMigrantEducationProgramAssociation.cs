    ...
    public class EdFiStudentMigrantEducationProgramAssociationJsonConverter : JsonConverter<EdFiStudentMigrantEducationProgramAssociation>
    {
        ...
        public override EdFiStudentMigrantEducationProgramAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (participationStatus.IsSet && participationStatus.Value == null)
                throw new ArgumentNullException(nameof(participationStatus), "Property is not nullable for class EdFiStudentMigrantEducationProgramAssociation.");
            ...
            return new EdFiStudentMigrantEducationProgramAssociation(beginDate.Value!.Value!, educationOrganizationReference.Value!, programReference.Value!, studentReference.Value!, lastQualifyingMove.Value!.Value!, priorityForServices.Value!.Value!, id, continuationOfServicesReasonDescriptor, eligibilityExpirationDate, endDate, migrantEducationProgramServices, participationStatus, programParticipationStatuses, qualifyingArrivalDate, reasonExitedDescriptor, servedOutsideOfRegularSession, stateResidencyDate, usInitialEntry, usInitialSchoolEntry, usMostRecentEntry, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentMigrantEducationProgramAssociation edFiStudentMigrantEducationProgramAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentMigrantEducationProgramAssociation.ParticipationStatusOption.IsSet && edFiStudentMigrantEducationProgramAssociation.ParticipationStatus == null)
                throw new ArgumentNullException(nameof(edFiStudentMigrantEducationProgramAssociation.ParticipationStatus), "Property is required for class EdFiStudentMigrantEducationProgramAssociation.");
            ...
            if (edFiStudentMigrantEducationProgramAssociation.ParticipationStatusOption.IsSet)
            {
                writer.WritePropertyName("participationStatus");
                JsonSerializer.Serialize(writer, edFiStudentMigrantEducationProgramAssociation.ParticipationStatus, jsonSerializerOptions);
            }
