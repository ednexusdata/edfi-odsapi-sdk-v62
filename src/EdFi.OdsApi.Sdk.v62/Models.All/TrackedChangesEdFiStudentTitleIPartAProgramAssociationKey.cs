...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentTitleIPartAProgramAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentTitleIPartAProgramAssociationKey(DateOnly beginDate = default, int educationOrganizationId = default, int programEducationOrganizationId = default, string programName = default, string programTypeDescriptor = default, string studentUniqueId = default)
        {
