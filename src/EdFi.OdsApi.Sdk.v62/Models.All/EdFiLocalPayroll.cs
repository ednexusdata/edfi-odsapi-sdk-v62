...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiLocalPayroll : IValidatableObject
    {
        ...
        public EdFiLocalPayroll(string id = default, DateOnly asOfDate = default, EdFiLocalAccountReference localAccountReference = default, EdFiStaffReference staffReference = default, double amount = default, string financialCollectionDescriptor = default, string etag = default, Object ext = default)
        {
