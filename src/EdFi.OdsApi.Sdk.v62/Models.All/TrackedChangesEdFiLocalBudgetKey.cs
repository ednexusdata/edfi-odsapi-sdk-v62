...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiLocalBudgetKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiLocalBudgetKey(DateOnly asOfDate = default, string accountIdentifier = default, int educationOrganizationId = default, int fiscalYear = default)
        {
