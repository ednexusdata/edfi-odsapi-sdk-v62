...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiCourseTranscript : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiCourseTranscript(string courseAttemptResultDescriptor, EdFiCourseReference courseReference, EdFiStudentAcademicRecordReference studentAcademicRecordReference, double earnedCredits, Option<string?> id = default, Option<EdFiEducationOrganizationReference?> externalEducationOrganizationReference = default, Option<List<EdFiCourseTranscriptAcademicSubject>?> academicSubjects = default, Option<string?> alternativeCourseCode = default, Option<List<EdFiCourseTranscriptAlternativeCourseIdentificationCode>?> alternativeCourseIdentificationCodes = default, Option<string?> alternativeCourseTitle = default, Option<string?> assigningOrganizationIdentificationCode = default, Option<double?> attemptedCreditConversion = default, Option<double?> attemptedCredits = default, Option<string?> attemptedCreditTypeDescriptor = default, Option<string?> courseCatalogURL = default, Option<string?> courseRepeatCodeDescriptor = default, Option<string?> courseTitle = default, Option<List<EdFiCourseTranscriptCreditCategory>?> creditCategories = default, Option<List<EdFiCourseTranscriptEarnedAdditionalCredits>?> earnedAdditionalCredits = default, Option<double?> earnedCreditConversion = default, Option<string?> earnedCreditTypeDescriptor = default, Option<string?> externalEducationOrganizationNameOfInstitution = default, Option<string?> finalLetterGradeEarned = default, Option<double?> finalNumericGradeEarned = default, Option<string?> methodCreditEarnedDescriptor = default, Option<List<EdFiCourseTranscriptPartialCourseTranscriptAwards>?> partialCourseTranscriptAwards = default, Option<string?> whenTakenGradeLevelDescriptor = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
            ...
            AlternativeCourseCodeOption = alternativeCourseCode;
        ...
        /// <summary>
        /// Used to track the state of AlternativeCourseCode
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> AlternativeCourseCodeOption { get; private set; }
        ...
        [JsonPropertyName("alternativeCourseCode")]
        public string? AlternativeCourseCode { get { return this.AlternativeCourseCodeOption; } set { this.AlternativeCourseCodeOption = new(value); } }
    ...
    public class EdFiCourseTranscriptJsonConverter : JsonConverter<EdFiCourseTranscript>
    {
        ...
        public override EdFiCourseTranscript Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> alternativeCourseCode = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "alternativeCourseCode":
                            alternativeCourseCode = new Option<string?>(utf8JsonReader.GetString());
                            break;
            ...
            if (!earnedCredits.IsSet)
                throw new ArgumentException("Property is required for class EdFiCourseTranscript.", nameof(earnedCredits));
            ...
            if (earnedCredits.IsSet && earnedCredits.Value == null)
                throw new ArgumentNullException(nameof(earnedCredits), "Property is not nullable for class EdFiCourseTranscript.");
            ...
            return new EdFiCourseTranscript(courseAttemptResultDescriptor.Value!, courseReference.Value!, studentAcademicRecordReference.Value!, earnedCredits.Value!.Value!, id, externalEducationOrganizationReference, academicSubjects, alternativeCourseCode, alternativeCourseIdentificationCodes, alternativeCourseTitle, assigningOrganizationIdentificationCode, attemptedCreditConversion, attemptedCredits, attemptedCreditTypeDescriptor, courseCatalogURL, courseRepeatCodeDescriptor, courseTitle, creditCategories, earnedAdditionalCredits, earnedCreditConversion, earnedCreditTypeDescriptor, externalEducationOrganizationNameOfInstitution, finalLetterGradeEarned, finalNumericGradeEarned, methodCreditEarnedDescriptor, partialCourseTranscriptAwards, whenTakenGradeLevelDescriptor, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiCourseTranscript edFiCourseTranscript, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteNumber("earnedCredits", edFiCourseTranscript.EarnedCredits);
            ...
            if (edFiCourseTranscript.AlternativeCourseCodeOption.IsSet)
                if (edFiCourseTranscript.AlternativeCourseCodeOption.Value != null)
                    writer.WriteString("alternativeCourseCode", edFiCourseTranscript.AlternativeCourseCode);
                else
                    writer.WriteNull("alternativeCourseCode");
