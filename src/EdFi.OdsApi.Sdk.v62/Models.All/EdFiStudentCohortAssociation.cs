...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentCohortAssociation : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiStudentCohortAssociation(DateOnly beginDate, EdFiCohortReference cohortReference, EdFiStudentReference studentReference, Option<string?> id = default, Option<DateOnly?> endDate = default, Option<List<EdFiStudentCohortAssociationSection>?> sections = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
            BeginDate = beginDate;
    ...
    public class EdFiStudentCohortAssociationJsonConverter : JsonConverter<EdFiStudentCohortAssociation>
    {
        ...
        public override EdFiStudentCohortAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiStudentCohortAssociation(beginDate.Value!.Value!, cohortReference.Value!, studentReference.Value!, id, endDate, sections, etag, ext);
        }
