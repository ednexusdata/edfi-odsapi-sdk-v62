...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public class EdFiLocalAccountJsonConverter : JsonConverter<EdFiLocalAccount>
    {
        ...
        public override EdFiLocalAccount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiLocalAccount(accountIdentifier.Value!, fiscalYear.Value!.Value!, chartOfAccountReference.Value!, educationOrganizationReference.Value!, id, accountName, reportingTags, etag, ext);
        }
