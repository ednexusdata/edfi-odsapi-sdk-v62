...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationKey(string incidentIdentifier = default, int schoolId = default, string studentUniqueId = default)
        {
