...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentSectionAttendanceEventKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiStudentSectionAttendanceEventKey(Option<string?> attendanceEventCategoryDescriptor = default, Option<DateOnly?> eventDate = default, Option<string?> localCourseCode = default, Option<int?> schoolId = default, Option<int?> schoolYear = default, Option<string?> sectionIdentifier = default, Option<string?> sessionName = default, Option<string?> studentUniqueId = default)
        {
