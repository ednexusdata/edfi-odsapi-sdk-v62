...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public class EdFiGradebookEntryJsonConverter : JsonConverter<EdFiGradebookEntry>
    {
        ...
        public override EdFiGradebookEntry Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiGradebookEntry(gradebookEntryIdentifier.Value!, varNamespace.Value!, dateAssigned.Value!.Value!, sourceSectionIdentifier.Value!, title.Value!, id, gradingPeriodReference, sectionReference, description, dueDate, dueTime, gradebookEntryTypeDescriptor, learningStandards, maxPoints, etag, ext);
        }
