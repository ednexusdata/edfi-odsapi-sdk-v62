    ...
    public class EdFiStudentNeglectedOrDelinquentProgramAssociationJsonConverter : JsonConverter<EdFiStudentNeglectedOrDelinquentProgramAssociation>
    {
        ...
        public override EdFiStudentNeglectedOrDelinquentProgramAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (participationStatus.IsSet && participationStatus.Value == null)
                throw new ArgumentNullException(nameof(participationStatus), "Property is not nullable for class EdFiStudentNeglectedOrDelinquentProgramAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentNeglectedOrDelinquentProgramAssociation edFiStudentNeglectedOrDelinquentProgramAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentNeglectedOrDelinquentProgramAssociation.ParticipationStatusOption.IsSet && edFiStudentNeglectedOrDelinquentProgramAssociation.ParticipationStatus == null)
                throw new ArgumentNullException(nameof(edFiStudentNeglectedOrDelinquentProgramAssociation.ParticipationStatus), "Property is required for class EdFiStudentNeglectedOrDelinquentProgramAssociation.");
            ...
            if (edFiStudentNeglectedOrDelinquentProgramAssociation.ParticipationStatusOption.IsSet)
            {
                writer.WritePropertyName("participationStatus");
                JsonSerializer.Serialize(writer, edFiStudentNeglectedOrDelinquentProgramAssociation.ParticipationStatus, jsonSerializerOptions);
            }
