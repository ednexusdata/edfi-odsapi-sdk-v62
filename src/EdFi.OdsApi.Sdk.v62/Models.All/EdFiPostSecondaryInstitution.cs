...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiPostSecondaryInstitution : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiPostSecondaryInstitution(List<EdFiEducationOrganizationCategory> categories, int postSecondaryInstitutionId, string nameOfInstitution, Option<string?> id = default, Option<List<EdFiEducationOrganizationAddress>?> addresses = default, Option<string?> administrativeFundingControlDescriptor = default, Option<List<EdFiEducationOrganizationIdentificationCode>?> identificationCodes = default, Option<List<EdFiEducationOrganizationIndicator>?> indicators = default, Option<List<EdFiEducationOrganizationInstitutionTelephone>?> institutionTelephones = default, Option<List<EdFiEducationOrganizationInternationalAddress>?> internationalAddresses = default, Option<List<EdFiPostSecondaryInstitutionMediumOfInstruction>?> mediumOfInstructions = default, Option<string?> operationalStatusDescriptor = default, Option<string?> postSecondaryInstitutionLevelDescriptor = default, Option<string?> shortNameOfInstitution = default, Option<string?> webSite = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiPostSecondaryInstitutionJsonConverter : JsonConverter<EdFiPostSecondaryInstitution>
    {
        ...
        public override EdFiPostSecondaryInstitution Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<int?> postSecondaryInstitutionId = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "postSecondaryInstitutionId":
                            postSecondaryInstitutionId = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
