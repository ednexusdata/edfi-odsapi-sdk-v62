...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public class EdFiObjectiveAssessmentJsonConverter : JsonConverter<EdFiObjectiveAssessment>
    {
        ...
        public override EdFiObjectiveAssessment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiObjectiveAssessment(identificationCode.Value!, assessmentReference.Value!, id, parentObjectiveAssessmentReference, academicSubjectDescriptor, assessmentItems, description, learningStandards, maxRawScore, nomenclature, percentOfAssessment, performanceLevels, scores, etag, ext);
        }
