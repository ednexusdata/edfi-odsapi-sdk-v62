...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiParentLanguage : IValidatableObject
    {
        ...
        public EdFiParentLanguage(string languageDescriptor = default, List<EdFiParentLanguageUse> uses = default, Object ext = default)
        {
            // to ensure "languageDescriptor" is required (not null)
            if (languageDescriptor == null)
            {
                throw new ArgumentNullException("languageDescriptor is a required property for EdFiParentLanguage and cannot be null");
            }
