...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiLearningStandard : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiLearningStandard(List<EdFiLearningStandardAcademicSubject> academicSubjects, List<EdFiLearningStandardGradeLevel> gradeLevels, string learningStandardId, string description, string @namespace, Option<string?> id = default, Option<EdFiLearningStandardReference?> parentLearningStandardReference = default, Option<EdFiLearningStandardContentStandard?> contentStandard = default, Option<string?> courseTitle = default, Option<List<EdFiLearningStandardIdentificationCode>?> identificationCodes = default, Option<string?> learningStandardCategoryDescriptor = default, Option<string?> learningStandardItemCode = default, Option<string?> learningStandardScopeDescriptor = default, Option<List<EdFiLearningStandardPrerequisiteLearningStandard>?> prerequisiteLearningStandards = default, Option<string?> successCriteria = default, Option<string?> uri = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
            ...
            PrerequisiteLearningStandardsOption = prerequisiteLearningStandards;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<EdFiLearningStandardContentStandard?> ContentStandardOption { get; private set; }

        /// <summary>
        /// Gets or Sets ContentStandard
        /// </summary>
        [JsonPropertyName("contentStandard")]
        public EdFiLearningStandardContentStandard? ContentStandard { get { return this.ContentStandardOption; } set { this.ContentStandardOption = new(value); } }
        ...
        /// <summary>
        /// Used to track the state of PrerequisiteLearningStandards
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiLearningStandardPrerequisiteLearningStandard>?> PrerequisiteLearningStandardsOption { get; private set; }
        ...
        [JsonPropertyName("prerequisiteLearningStandards")]
        public List<EdFiLearningStandardPrerequisiteLearningStandard>? PrerequisiteLearningStandards { get { return this.PrerequisiteLearningStandardsOption; } set { this.PrerequisiteLearningStandardsOption = new(value); } }
    ...
    public class EdFiLearningStandardJsonConverter : JsonConverter<EdFiLearningStandard>
    {
        ...
        public override EdFiLearningStandard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EdFiLearningStandardPrerequisiteLearningStandard>?> prerequisiteLearningStandards = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "learningStandardScopeDescriptor":
                            ...
                            break;
                        case "prerequisiteLearningStandards":
                            prerequisiteLearningStandards = new Option<List<EdFiLearningStandardPrerequisiteLearningStandard>?>(JsonSerializer.Deserialize<List<EdFiLearningStandardPrerequisiteLearningStandard>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
            ...
            if (prerequisiteLearningStandards.IsSet && prerequisiteLearningStandards.Value == null)
                throw new ArgumentNullException(nameof(prerequisiteLearningStandards), "Property is not nullable for class EdFiLearningStandard.");
            ...
            return new EdFiLearningStandard(academicSubjects.Value!, gradeLevels.Value!, learningStandardId.Value!, description.Value!, varNamespace.Value!, id, parentLearningStandardReference, contentStandard, courseTitle, identificationCodes, learningStandardCategoryDescriptor, learningStandardItemCode, learningStandardScopeDescriptor, prerequisiteLearningStandards, successCriteria, uri, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiLearningStandard edFiLearningStandard, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiLearningStandard.ContentStandardOption.IsSet && edFiLearningStandard.ContentStandard == null)
            ...
            if (edFiLearningStandard.PrerequisiteLearningStandardsOption.IsSet && edFiLearningStandard.PrerequisiteLearningStandards == null)
                throw new ArgumentNullException(nameof(edFiLearningStandard.PrerequisiteLearningStandards), "Property is required for class EdFiLearningStandard.");
            ...
            if (edFiLearningStandard.ContentStandardOption.IsSet)
            {
            ...
            if (edFiLearningStandard.PrerequisiteLearningStandardsOption.IsSet)
            {
                writer.WritePropertyName("prerequisiteLearningStandards");
                JsonSerializer.Serialize(writer, edFiLearningStandard.PrerequisiteLearningStandards, jsonSerializerOptions);
            }
