...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiLocalActual : IValidatableObject
    {
        ...
        public EdFiLocalActual(string id = default, DateOnly asOfDate = default, EdFiLocalAccountReference localAccountReference = default, double amount = default, string financialCollectionDescriptor = default, string etag = default, Object ext = default)
        {
