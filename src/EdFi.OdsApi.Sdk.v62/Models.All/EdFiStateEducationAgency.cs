...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStateEducationAgency : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiStateEducationAgency(List<EdFiEducationOrganizationCategory> categories, int stateEducationAgencyId, string nameOfInstitution, Option<string?> id = default, Option<List<EdFiStateEducationAgencyAccountability>?> accountabilities = default, Option<List<EdFiEducationOrganizationAddress>?> addresses = default, Option<List<EdFiStateEducationAgencyFederalFunds>?> federalFunds = default, Option<List<EdFiEducationOrganizationIdentificationCode>?> identificationCodes = default, Option<List<EdFiEducationOrganizationIndicator>?> indicators = default, Option<List<EdFiEducationOrganizationInstitutionTelephone>?> institutionTelephones = default, Option<List<EdFiEducationOrganizationInternationalAddress>?> internationalAddresses = default, Option<string?> operationalStatusDescriptor = default, Option<string?> shortNameOfInstitution = default, Option<string?> webSite = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiStateEducationAgencyJsonConverter : JsonConverter<EdFiStateEducationAgency>
    {
        ...
        public override EdFiStateEducationAgency Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiStateEducationAgency(categories.Value!, stateEducationAgencyId.Value!.Value!, nameOfInstitution.Value!, id, accountabilities, addresses, federalFunds, identificationCodes, indicators, institutionTelephones, internationalAddresses, operationalStatusDescriptor, shortNameOfInstitution, webSite, etag, ext);
        }
