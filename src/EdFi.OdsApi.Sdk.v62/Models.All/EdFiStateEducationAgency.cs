...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStateEducationAgency : IValidatableObject
    {
        ...
        public EdFiStateEducationAgency(string id = default, List<EdFiEducationOrganizationCategory> categories = default, int stateEducationAgencyId = default, List<EdFiStateEducationAgencyAccountability> accountabilities = default, List<EdFiEducationOrganizationAddress> addresses = default, List<EdFiStateEducationAgencyFederalFunds> federalFunds = default, List<EdFiEducationOrganizationIdentificationCode> identificationCodes = default, List<EdFiEducationOrganizationIndicator> indicators = default, List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones = default, List<EdFiEducationOrganizationInternationalAddress> internationalAddresses = default, string nameOfInstitution = default, string operationalStatusDescriptor = default, string shortNameOfInstitution = default, string webSite = default, string etag = default, Object ext = default)
        {
