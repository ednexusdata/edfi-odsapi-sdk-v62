...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiAbsenceEventCategoryDescriptor : IValidatableObject
    {
        ...
        public EdFiAbsenceEventCategoryDescriptor(string id = default, int absenceEventCategoryDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
