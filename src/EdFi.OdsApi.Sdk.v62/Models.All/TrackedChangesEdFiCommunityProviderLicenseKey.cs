...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiCommunityProviderLicenseKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiCommunityProviderLicenseKey(string licenseIdentifier = default, string licensingOrganization = default, int communityProviderId = default)
        {
