...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiTribalAffiliationDescriptor : IValidatableObject
    {
        ...
        public EdFiTribalAffiliationDescriptor(string id = default, int tribalAffiliationDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
