...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentCompetencyObjectiveKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentCompetencyObjectiveKey(int objectiveEducationOrganizationId = default, string objective = default, string objectiveGradeLevelDescriptor = default, string gradingPeriodDescriptor = default, int gradingPeriodSequence = default, int gradingPeriodSchoolId = default, int gradingPeriodSchoolYear = default, string studentUniqueId = default)
        {
