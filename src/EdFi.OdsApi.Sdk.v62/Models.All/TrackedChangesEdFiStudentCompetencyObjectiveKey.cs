...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentCompetencyObjectiveKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiStudentCompetencyObjectiveKey(Option<int?> objectiveEducationOrganizationId = default, Option<string?> objective = default, Option<string?> objectiveGradeLevelDescriptor = default, Option<string?> gradingPeriodDescriptor = default, Option<int?> gradingPeriodSequence = default, Option<int?> gradingPeriodSchoolId = default, Option<int?> gradingPeriodSchoolYear = default, Option<string?> studentUniqueId = default)
        {
        ...
        public Option<int?> ObjectiveEducationOrganizationIdOption { get; private set; }
        ...
        public int? ObjectiveEducationOrganizationId { get { return this.ObjectiveEducationOrganizationIdOption; } set { this.ObjectiveEducationOrganizationIdOption = new(value); } }
    ...
    public class TrackedChangesEdFiStudentCompetencyObjectiveKeyJsonConverter : JsonConverter<TrackedChangesEdFiStudentCompetencyObjectiveKey>
    {
        ...
        public override TrackedChangesEdFiStudentCompetencyObjectiveKey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (gradingPeriodSequence.IsSet && gradingPeriodSequence.Value == null)
                throw new ArgumentNullException(nameof(gradingPeriodSequence), "Property is not nullable for class TrackedChangesEdFiStudentCompetencyObjectiveKey.");
            ...
            return new TrackedChangesEdFiStudentCompetencyObjectiveKey(objectiveEducationOrganizationId, objective, objectiveGradeLevelDescriptor, gradingPeriodDescriptor, gradingPeriodSequence, gradingPeriodSchoolId, gradingPeriodSchoolYear, studentUniqueId);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, TrackedChangesEdFiStudentCompetencyObjectiveKey trackedChangesEdFiStudentCompetencyObjectiveKey, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (trackedChangesEdFiStudentCompetencyObjectiveKey.GradingPeriodSequenceOption.IsSet)
                writer.WriteNumber("gradingPeriodSequence", trackedChangesEdFiStudentCompetencyObjectiveKey.GradingPeriodSequenceOption.Value!.Value);
