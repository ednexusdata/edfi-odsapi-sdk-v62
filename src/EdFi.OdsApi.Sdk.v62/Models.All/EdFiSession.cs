...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiSession : IValidatableObject
    {
        ...
        public EdFiSession(string id = default, string sessionName = default, EdFiSchoolReference schoolReference = default, EdFiSchoolYearTypeReference schoolYearTypeReference = default, List<EdFiSessionAcademicWeek> academicWeeks = default, DateOnly beginDate = default, DateOnly endDate = default, List<EdFiSessionGradingPeriod> gradingPeriods = default, string termDescriptor = default, int totalInstructionalDays = default, string etag = default, Object ext = default)
        {
