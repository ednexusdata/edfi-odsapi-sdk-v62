...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiCourse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiCourse(string courseCode, List<EdFiCourseIdentificationCode> identificationCodes, EdFiEducationOrganizationReference educationOrganizationReference, string courseTitle, int numberOfParts, Option<string?> id = default, Option<string?> academicSubjectDescriptor = default, Option<string?> careerPathwayDescriptor = default, Option<List<EdFiCourseCompetencyLevel>?> competencyLevels = default, Option<string?> courseDefinedByDescriptor = default, Option<string?> courseDescription = default, Option<string?> courseGPAApplicabilityDescriptor = default, Option<DateOnly?> dateCourseAdopted = default, Option<bool?> highSchoolCourseRequirement = default, Option<List<EdFiCourseLearningObjective>?> learningObjectives = default, Option<List<EdFiCourseLearningStandard>?> learningStandards = default, Option<List<EdFiCourseLevelCharacteristic>?> levelCharacteristics = default, Option<int?> maxCompletionsForCredit = default, Option<double?> maximumAvailableCreditConversion = default, Option<double?> maximumAvailableCredits = default, Option<string?> maximumAvailableCreditTypeDescriptor = default, Option<double?> minimumAvailableCreditConversion = default, Option<double?> minimumAvailableCredits = default, Option<string?> minimumAvailableCreditTypeDescriptor = default, Option<List<EdFiCourseOfferedGradeLevel>?> offeredGradeLevels = default, Option<int?> timeRequiredForCompletion = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiCourseLearningObjective>?> LearningObjectivesOption { get; private set; }
        ...
        public List<EdFiCourseLearningObjective>? LearningObjectives { get { return this.LearningObjectivesOption; } set { this.LearningObjectivesOption = new(value); } }
    ...
    public class EdFiCourseJsonConverter : JsonConverter<EdFiCourse>
    {
        ...
        public override EdFiCourse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EdFiCourseLearningObjective>?> learningObjectives = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "learningObjectives":
                            learningObjectives = new Option<List<EdFiCourseLearningObjective>?>(JsonSerializer.Deserialize<List<EdFiCourseLearningObjective>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
            ...
            if (learningObjectives.IsSet && learningObjectives.Value == null)
                throw new ArgumentNullException(nameof(learningObjectives), "Property is not nullable for class EdFiCourse.");
            ...
            return new EdFiCourse(courseCode.Value!, identificationCodes.Value!, educationOrganizationReference.Value!, courseTitle.Value!, numberOfParts.Value!.Value!, id, academicSubjectDescriptor, careerPathwayDescriptor, competencyLevels, courseDefinedByDescriptor, courseDescription, courseGPAApplicabilityDescriptor, dateCourseAdopted, highSchoolCourseRequirement, learningObjectives, learningStandards, levelCharacteristics, maxCompletionsForCredit, maximumAvailableCreditConversion, maximumAvailableCredits, maximumAvailableCreditTypeDescriptor, minimumAvailableCreditConversion, minimumAvailableCredits, minimumAvailableCreditTypeDescriptor, offeredGradeLevels, timeRequiredForCompletion, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiCourse edFiCourse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiCourse.LearningObjectivesOption.IsSet && edFiCourse.LearningObjectives == null)
                throw new ArgumentNullException(nameof(edFiCourse.LearningObjectives), "Property is required for class EdFiCourse.");
            ...
            if (edFiCourse.AcademicSubjectDescriptorOption.IsSet)
                if (edFiCourse.AcademicSubjectDescriptorOption.Value != null)
                    writer.WriteString("academicSubjectDescriptor", edFiCourse.AcademicSubjectDescriptor);
                else
            ...
            if (edFiCourse.LearningObjectivesOption.IsSet)
            {
                writer.WritePropertyName("learningObjectives");
                JsonSerializer.Serialize(writer, edFiCourse.LearningObjectives, jsonSerializerOptions);
            }
