...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiEducationOrganizationInterventionPrescriptionAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiEducationOrganizationInterventionPrescriptionAssociationKey(int educationOrganizationId = default, int interventionPrescriptionEducationOrganizationId = default, string interventionPrescriptionIdentificationCode = default)
        {
