...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveyResponseEducationOrganizationTargetAssociationKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiSurveyResponseEducationOrganizationTargetAssociationKey(Option<int?> educationOrganizationId = default, Option<string?> @namespace = default, Option<string?> surveyIdentifier = default, Option<string?> surveyResponseIdentifier = default)
        {
