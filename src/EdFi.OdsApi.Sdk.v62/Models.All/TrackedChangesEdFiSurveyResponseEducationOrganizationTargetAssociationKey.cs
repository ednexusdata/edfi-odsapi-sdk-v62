...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveyResponseEducationOrganizationTargetAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiSurveyResponseEducationOrganizationTargetAssociationKey(int educationOrganizationId = default, string varNamespace = default, string surveyIdentifier = default, string surveyResponseIdentifier = default)
        {
