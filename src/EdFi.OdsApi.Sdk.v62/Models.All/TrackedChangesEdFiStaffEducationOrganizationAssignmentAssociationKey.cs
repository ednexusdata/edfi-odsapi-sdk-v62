...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStaffEducationOrganizationAssignmentAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStaffEducationOrganizationAssignmentAssociationKey(string staffClassificationDescriptor = default, DateOnly beginDate = default, int educationOrganizationId = default, string staffUniqueId = default)
        {
