...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStaffEducationOrganizationAssignmentAssociationKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiStaffEducationOrganizationAssignmentAssociationKey(Option<string?> staffClassificationDescriptor = default, Option<DateOnly?> beginDate = default, Option<int?> educationOrganizationId = default, Option<string?> staffUniqueId = default)
        {
