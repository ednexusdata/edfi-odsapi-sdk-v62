...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiSectionAttendanceTakenEventKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiSectionAttendanceTakenEventKey(string calendarCode = default, DateOnly date = default, int schoolId = default, int schoolYear = default, string localCourseCode = default, string sectionIdentifier = default, string sessionName = default)
        {
