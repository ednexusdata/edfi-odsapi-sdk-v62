...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentSectionAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentSectionAssociationKey(DateOnly beginDate = default, string localCourseCode = default, int schoolId = default, int schoolYear = default, string sectionIdentifier = default, string sessionName = default, string studentUniqueId = default)
        {
