...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiSurveySection : IValidatableObject
    {
        ...
        public EdFiSurveySection(string id = default, string surveySectionTitle = default, EdFiSurveyReference surveyReference = default, string etag = default, Object ext = default)
        {
