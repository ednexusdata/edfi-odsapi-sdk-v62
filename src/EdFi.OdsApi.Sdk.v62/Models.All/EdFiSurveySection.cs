...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiSurveySection : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiSurveySection(string surveySectionTitle, EdFiSurveyReference surveyReference, Option<string?> id = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiSurveySectionJsonConverter : JsonConverter<EdFiSurveySection>
    {
        ...
        public override EdFiSurveySection Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiSurveySection(surveySectionTitle.Value!, surveyReference.Value!, id, etag, ext);
        }
