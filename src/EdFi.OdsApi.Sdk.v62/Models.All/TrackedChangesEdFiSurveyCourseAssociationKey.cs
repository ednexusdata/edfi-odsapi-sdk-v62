...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveyCourseAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiSurveyCourseAssociationKey(string courseCode = default, int educationOrganizationId = default, string varNamespace = default, string surveyIdentifier = default)
        {
