...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiCompetencyObjectiveKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiCompetencyObjectiveKey(string objectiveGradeLevelDescriptor = default, string objective = default, int educationOrganizationId = default)
        {
