...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiClassPeriod : IValidatableObject
    {
        ...
        public EdFiClassPeriod(string id = default, string classPeriodName = default, EdFiSchoolReference schoolReference = default, List<EdFiClassPeriodMeetingTime> meetingTimes = default, bool? officialAttendancePeriod = default, string etag = default, Object ext = default)
        {
