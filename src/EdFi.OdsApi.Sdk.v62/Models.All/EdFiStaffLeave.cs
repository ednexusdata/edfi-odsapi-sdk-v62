...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStaffLeave : IValidatableObject
    {
        ...
        public EdFiStaffLeave(string id = default, DateOnly beginDate = default, string staffLeaveEventCategoryDescriptor = default, EdFiStaffReference staffReference = default, DateOnly? endDate = default, string reason = default, bool? substituteAssigned = default, string etag = default, Object ext = default)
        {
