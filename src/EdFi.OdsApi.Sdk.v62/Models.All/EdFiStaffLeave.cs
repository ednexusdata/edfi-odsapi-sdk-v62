...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStaffLeave : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiStaffLeave(DateOnly beginDate, string staffLeaveEventCategoryDescriptor, EdFiStaffReference staffReference, Option<string?> id = default, Option<DateOnly?> endDate = default, Option<string?> reason = default, Option<bool?> substituteAssigned = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
            BeginDate = beginDate;
    ...
    public class EdFiStaffLeaveJsonConverter : JsonConverter<EdFiStaffLeave>
    {
        ...
        public override EdFiStaffLeave Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiStaffLeave(beginDate.Value!.Value!, staffLeaveEventCategoryDescriptor.Value!, staffReference.Value!, id, endDate, reason, substituteAssigned, etag, ext);
        }
