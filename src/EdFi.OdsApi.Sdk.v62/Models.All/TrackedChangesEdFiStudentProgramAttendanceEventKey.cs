...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentProgramAttendanceEventKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentProgramAttendanceEventKey(string attendanceEventCategoryDescriptor = default, DateOnly eventDate = default, int educationOrganizationId = default, int programEducationOrganizationId = default, string programName = default, string programTypeDescriptor = default, string studentUniqueId = default)
        {
