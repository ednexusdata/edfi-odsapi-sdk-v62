...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentProgramAttendanceEventKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiStudentProgramAttendanceEventKey(Option<string?> attendanceEventCategoryDescriptor = default, Option<DateOnly?> eventDate = default, Option<int?> educationOrganizationId = default, Option<int?> programEducationOrganizationId = default, Option<string?> programName = default, Option<string?> programTypeDescriptor = default, Option<string?> studentUniqueId = default)
        {
