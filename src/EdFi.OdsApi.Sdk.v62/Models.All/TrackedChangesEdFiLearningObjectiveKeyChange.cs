...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_learningObjectiveKeyChange")]
    public partial class TrackedChangesEdFiLearningObjectiveKeyChange : IValidatableObject
    {
        ...
        public TrackedChangesEdFiLearningObjectiveKeyChange(string id = default, decimal changeVersion = default, TrackedChangesEdFiLearningObjectiveKey oldKeyValues = default, TrackedChangesEdFiLearningObjectiveKey newKeyValues = default)
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiLearningObjectiveKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiLearningObjectiveKey NewKeyValues { get; set; }
