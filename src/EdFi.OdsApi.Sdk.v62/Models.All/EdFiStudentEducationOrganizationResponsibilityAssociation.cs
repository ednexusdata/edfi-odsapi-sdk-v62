...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentEducationOrganizationResponsibilityAssociation : IValidatableObject
    {
        ...
        public EdFiStudentEducationOrganizationResponsibilityAssociation(string id = default, DateOnly beginDate = default, string responsibilityDescriptor = default, EdFiEducationOrganizationReference educationOrganizationReference = default, EdFiStudentReference studentReference = default, DateOnly? endDate = default, string etag = default, Object ext = default)
        {
