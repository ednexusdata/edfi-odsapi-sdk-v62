...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey(string employmentStatusDescriptor = default, DateOnly hireDate = default, int educationOrganizationId = default, string staffUniqueId = default)
        {
