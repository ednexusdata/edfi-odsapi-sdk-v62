...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentInterventionAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentInterventionAssociationKey(int educationOrganizationId = default, string interventionIdentificationCode = default, string studentUniqueId = default)
        {
