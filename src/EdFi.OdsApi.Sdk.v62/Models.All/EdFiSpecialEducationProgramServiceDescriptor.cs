...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiSpecialEducationProgramServiceDescriptor : IValidatableObject
    {
        ...
        public EdFiSpecialEducationProgramServiceDescriptor(string id = default, int specialEducationProgramServiceDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
