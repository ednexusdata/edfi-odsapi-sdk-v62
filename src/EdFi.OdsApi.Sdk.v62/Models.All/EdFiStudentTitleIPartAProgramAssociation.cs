...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentTitleIPartAProgramAssociation : IValidatableObject
    {
        ...
        public EdFiStudentTitleIPartAProgramAssociation(string id = default, DateOnly beginDate = default, EdFiEducationOrganizationReference educationOrganizationReference = default, EdFiProgramReference programReference = default, EdFiStudentReference studentReference = default, DateOnly? endDate = default, EdFiGeneralStudentProgramAssociationParticipationStatus participationStatus = default, List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default, string reasonExitedDescriptor = default, bool? servedOutsideOfRegularSession = default, List<EdFiStudentTitleIPartAProgramAssociationService> services = default, string titleIPartAParticipantDescriptor = default, List<EdFiStudentTitleIPartAProgramAssociationTitleIPartAProgramService> titleIPartAProgramServices = default, string etag = default, Object ext = default)
        {
