...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiCompetencyObjective : IValidatableObject
    {
        ...
        public EdFiCompetencyObjective(string id = default, string objective = default, string objectiveGradeLevelDescriptor = default, EdFiEducationOrganizationReference educationOrganizationReference = default, string competencyObjectiveId = default, string description = default, string successCriteria = default, string etag = default, Object ext = default)
        {
