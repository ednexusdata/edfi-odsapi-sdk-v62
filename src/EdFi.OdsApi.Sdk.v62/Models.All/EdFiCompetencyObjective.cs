...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiCompetencyObjective : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiCompetencyObjective(string objective, string objectiveGradeLevelDescriptor, EdFiEducationOrganizationReference educationOrganizationReference, Option<string?> id = default, Option<string?> competencyObjectiveId = default, Option<string?> description = default, Option<string?> successCriteria = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
            Objective = objective;
    ...
    public class EdFiCompetencyObjectiveJsonConverter : JsonConverter<EdFiCompetencyObjective>
    {
        ...
        public override EdFiCompetencyObjective Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiCompetencyObjective(objective.Value!, objectiveGradeLevelDescriptor.Value!, educationOrganizationReference.Value!, id, competencyObjectiveId, description, successCriteria, etag, ext);
        }
