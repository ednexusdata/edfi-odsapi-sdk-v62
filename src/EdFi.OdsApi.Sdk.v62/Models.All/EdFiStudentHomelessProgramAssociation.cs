...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentHomelessProgramAssociation : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiStudentHomelessProgramAssociation(DateOnly beginDate, EdFiEducationOrganizationReference educationOrganizationReference, EdFiProgramReference programReference, EdFiStudentReference studentReference, Option<string?> id = default, Option<bool?> awaitingFosterCare = default, Option<DateOnly?> endDate = default, Option<string?> homelessPrimaryNighttimeResidenceDescriptor = default, Option<List<EdFiStudentHomelessProgramAssociationHomelessProgramService>?> homelessProgramServices = default, Option<bool?> homelessUnaccompaniedYouth = default, Option<EdFiGeneralStudentProgramAssociationParticipationStatus?> participationStatus = default, Option<List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus>?> programParticipationStatuses = default, Option<string?> reasonExitedDescriptor = default, Option<bool?> servedOutsideOfRegularSession = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
            BeginDate = beginDate;
    ...
    public class EdFiStudentHomelessProgramAssociationJsonConverter : JsonConverter<EdFiStudentHomelessProgramAssociation>
    {
        ...
        public override EdFiStudentHomelessProgramAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (participationStatus.IsSet && participationStatus.Value == null)
                throw new ArgumentNullException(nameof(participationStatus), "Property is not nullable for class EdFiStudentHomelessProgramAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentHomelessProgramAssociation edFiStudentHomelessProgramAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentHomelessProgramAssociation.ParticipationStatusOption.IsSet && edFiStudentHomelessProgramAssociation.ParticipationStatus == null)
                throw new ArgumentNullException(nameof(edFiStudentHomelessProgramAssociation.ParticipationStatus), "Property is required for class EdFiStudentHomelessProgramAssociation.");
            ...
            if (edFiStudentHomelessProgramAssociation.ParticipationStatusOption.IsSet)
            {
                writer.WritePropertyName("participationStatus");
                JsonSerializer.Serialize(writer, edFiStudentHomelessProgramAssociation.ParticipationStatus, jsonSerializerOptions);
            }
