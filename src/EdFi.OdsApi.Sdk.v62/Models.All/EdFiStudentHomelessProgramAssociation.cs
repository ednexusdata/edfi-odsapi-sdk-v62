...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentHomelessProgramAssociation : IValidatableObject
    {
        ...
        public EdFiStudentHomelessProgramAssociation(string id = default, DateOnly beginDate = default, EdFiEducationOrganizationReference educationOrganizationReference = default, EdFiProgramReference programReference = default, EdFiStudentReference studentReference = default, bool? awaitingFosterCare = default, DateOnly? endDate = default, string homelessPrimaryNighttimeResidenceDescriptor = default, List<EdFiStudentHomelessProgramAssociationHomelessProgramService> homelessProgramServices = default, bool? homelessUnaccompaniedYouth = default, EdFiGeneralStudentProgramAssociationParticipationStatus participationStatus = default, List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default, string reasonExitedDescriptor = default, bool? servedOutsideOfRegularSession = default, string etag = default, Object ext = default)
        {
