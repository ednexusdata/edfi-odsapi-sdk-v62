...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStaffSectionAssociation : IValidatableObject
    {
        ...
        public EdFiStaffSectionAssociation(string id = default, EdFiSectionReference sectionReference = default, EdFiStaffReference staffReference = default, DateOnly? beginDate = default, string classroomPositionDescriptor = default, DateOnly? endDate = default, bool? highlyQualifiedTeacher = default, double? percentageContribution = default, bool? teacherStudentDataLinkExclusion = default, string etag = default, Object ext = default)
        {
