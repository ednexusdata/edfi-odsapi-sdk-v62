...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStaffSectionAssociation : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiStaffSectionAssociation(EdFiSectionReference sectionReference, EdFiStaffReference staffReference, string classroomPositionDescriptor, Option<string?> id = default, Option<DateOnly?> beginDate = default, Option<DateOnly?> endDate = default, Option<bool?> highlyQualifiedTeacher = default, Option<double?> percentageContribution = default, Option<bool?> teacherStudentDataLinkExclusion = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiStaffSectionAssociationJsonConverter : JsonConverter<EdFiStaffSectionAssociation>
    {
        ...
        public override EdFiStaffSectionAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiStaffSectionAssociation(sectionReference.Value!, staffReference.Value!, classroomPositionDescriptor.Value!, id, beginDate, endDate, highlyQualifiedTeacher, percentageContribution, teacherStudentDataLinkExclusion, etag, ext);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStaffSectionAssociation edFiStaffSectionAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStaffSectionAssociation.BeginDateOption.IsSet)
                if (edFiStaffSectionAssociation.BeginDateOption.Value != null)
                    writer.WriteString("beginDate", edFiStaffSectionAssociation.BeginDateOption.Value!.Value.ToString(BeginDateFormat));
                else
