...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiParentInternationalAddress : IValidatableObject
    {
        ...
        public EdFiParentInternationalAddress(string addressTypeDescriptor = default, string countryDescriptor = default, string addressLine1 = default, string addressLine2 = default, string addressLine3 = default, string addressLine4 = default, DateOnly? beginDate = default, DateOnly? endDate = default, string latitude = default, string longitude = default, Object ext = default)
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            if (addressTypeDescriptor == null)
            {
                throw new ArgumentNullException("addressTypeDescriptor is a required property for EdFiParentInternationalAddress and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("countryDescriptor is a required property for EdFiParentInternationalAddress and cannot be null");
            }
            this.CountryDescriptor = countryDescriptor;
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for EdFiParentInternationalAddress and cannot be null");
            }
