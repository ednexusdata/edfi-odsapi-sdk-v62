...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    /// </summary>
    public partial class EdFiParentInternationalAddress : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the ParentInternationalAddress entity.</param>
        [JsonConstructor]
        public EdFiParentInternationalAddress(string addressTypeDescriptor, string countryDescriptor, string addressLine1, Option<string?> addressLine2 = default, Option<string?> addressLine3 = default, Option<string?> addressLine4 = default, Option<DateOnly?> beginDate = default, Option<DateOnly?> endDate = default, Option<string?> latitude = default, Option<string?> longitude = default, Option<Object?> ext = default)
        {
        ...
        /// <summary>
        /// Extensions to the ParentInternationalAddress entity.
        /// </summary>
        /// <value>Extensions to the ParentInternationalAddress entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiParentInternationalAddress" />
    /// </summary>
    public class EdFiParentInternationalAddressJsonConverter : JsonConverter<EdFiParentInternationalAddress>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="EdFiParentInternationalAddress" />
        /// </summary>
        ...
        public override EdFiParentInternationalAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!addressTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentInternationalAddress.", nameof(addressTypeDescriptor));

            if (!countryDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentInternationalAddress.", nameof(countryDescriptor));

            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentInternationalAddress.", nameof(addressLine1));

            if (addressTypeDescriptor.IsSet && addressTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(addressTypeDescriptor), "Property is not nullable for class EdFiParentInternationalAddress.");

            if (countryDescriptor.IsSet && countryDescriptor.Value == null)
                throw new ArgumentNullException(nameof(countryDescriptor), "Property is not nullable for class EdFiParentInternationalAddress.");

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class EdFiParentInternationalAddress.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiParentInternationalAddress.");

            return new EdFiParentInternationalAddress(addressTypeDescriptor.Value!, countryDescriptor.Value!, addressLine1.Value!, addressLine2, addressLine3, addressLine4, beginDate, endDate, latitude, longitude, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiParentInternationalAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiParentInternationalAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiParentInternationalAddress edFiParentInternationalAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiParentInternationalAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiParentInternationalAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiParentInternationalAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiParentInternationalAddress edFiParentInternationalAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiParentInternationalAddress.AddressTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiParentInternationalAddress.AddressTypeDescriptor), "Property is required for class EdFiParentInternationalAddress.");

            if (edFiParentInternationalAddress.CountryDescriptor == null)
                throw new ArgumentNullException(nameof(edFiParentInternationalAddress.CountryDescriptor), "Property is required for class EdFiParentInternationalAddress.");

            if (edFiParentInternationalAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(edFiParentInternationalAddress.AddressLine1), "Property is required for class EdFiParentInternationalAddress.");

            if (edFiParentInternationalAddress.ExtOption.IsSet && edFiParentInternationalAddress.Ext == null)
                throw new ArgumentNullException(nameof(edFiParentInternationalAddress.Ext), "Property is required for class EdFiParentInternationalAddress.");

            writer.WriteString("addressTypeDescriptor", edFiParentInternationalAddress.AddressTypeDescriptor);

            writer.WriteString("countryDescriptor", edFiParentInternationalAddress.CountryDescriptor);

            writer.WriteString("addressLine1", edFiParentInternationalAddress.AddressLine1);

            if (edFiParentInternationalAddress.AddressLine2Option.IsSet)
                if (edFiParentInternationalAddress.AddressLine2Option.Value != null)
                    writer.WriteString("addressLine2", edFiParentInternationalAddress.AddressLine2);
                else
                    writer.WriteNull("addressLine2");

            if (edFiParentInternationalAddress.AddressLine3Option.IsSet)
                if (edFiParentInternationalAddress.AddressLine3Option.Value != null)
                    writer.WriteString("addressLine3", edFiParentInternationalAddress.AddressLine3);
                else
                    writer.WriteNull("addressLine3");

            if (edFiParentInternationalAddress.AddressLine4Option.IsSet)
                if (edFiParentInternationalAddress.AddressLine4Option.Value != null)
                    writer.WriteString("addressLine4", edFiParentInternationalAddress.AddressLine4);
                else
                    writer.WriteNull("addressLine4");

            if (edFiParentInternationalAddress.BeginDateOption.IsSet)
                if (edFiParentInternationalAddress.BeginDateOption.Value != null)
                    writer.WriteString("beginDate", edFiParentInternationalAddress.BeginDateOption.Value!.Value.ToString(BeginDateFormat));
                else
                    writer.WriteNull("beginDate");

            if (edFiParentInternationalAddress.EndDateOption.IsSet)
                if (edFiParentInternationalAddress.EndDateOption.Value != null)
                    writer.WriteString("endDate", edFiParentInternationalAddress.EndDateOption.Value!.Value.ToString(EndDateFormat));
                else
                    writer.WriteNull("endDate");

            if (edFiParentInternationalAddress.LatitudeOption.IsSet)
                if (edFiParentInternationalAddress.LatitudeOption.Value != null)
                    writer.WriteString("latitude", edFiParentInternationalAddress.Latitude);
                else
                    writer.WriteNull("latitude");

            if (edFiParentInternationalAddress.LongitudeOption.IsSet)
                if (edFiParentInternationalAddress.LongitudeOption.Value != null)
                    writer.WriteString("longitude", edFiParentInternationalAddress.Longitude);
                else
                    writer.WriteNull("longitude");

            if (edFiParentInternationalAddress.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiParentInternationalAddress.Ext, jsonSerializerOptions);
            }
        }
    }
}
