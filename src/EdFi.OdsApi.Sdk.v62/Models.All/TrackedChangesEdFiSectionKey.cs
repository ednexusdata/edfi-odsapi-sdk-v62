...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiSectionKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiSectionKey(string sectionIdentifier = default, string localCourseCode = default, int schoolId = default, int schoolYear = default, string sessionName = default)
        {
