    ...
    public class EdFiStudentSpecialEducationProgramAssociationJsonConverter : JsonConverter<EdFiStudentSpecialEducationProgramAssociation>
    {
        ...
        public override EdFiStudentSpecialEducationProgramAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (participationStatus.IsSet && participationStatus.Value == null)
                throw new ArgumentNullException(nameof(participationStatus), "Property is not nullable for class EdFiStudentSpecialEducationProgramAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, EdFiStudentSpecialEducationProgramAssociation edFiStudentSpecialEducationProgramAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (edFiStudentSpecialEducationProgramAssociation.ParticipationStatusOption.IsSet && edFiStudentSpecialEducationProgramAssociation.ParticipationStatus == null)
                throw new ArgumentNullException(nameof(edFiStudentSpecialEducationProgramAssociation.ParticipationStatus), "Property is required for class EdFiStudentSpecialEducationProgramAssociation.");
            ...
            if (edFiStudentSpecialEducationProgramAssociation.ParticipationStatusOption.IsSet)
            {
                writer.WritePropertyName("participationStatus");
                JsonSerializer.Serialize(writer, edFiStudentSpecialEducationProgramAssociation.ParticipationStatus, jsonSerializerOptions);
            }
