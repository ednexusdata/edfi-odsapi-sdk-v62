...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiAccountabilityRating : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiAccountabilityRating(string ratingTitle, EdFiEducationOrganizationReference educationOrganizationReference, EdFiSchoolYearTypeReference schoolYearTypeReference, string rating, Option<string?> id = default, Option<DateOnly?> ratingDate = default, Option<string?> ratingOrganization = default, Option<string?> ratingProgram = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiAccountabilityRatingJsonConverter : JsonConverter<EdFiAccountabilityRating>
    {
        ...
        public override EdFiAccountabilityRating Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiAccountabilityRating(ratingTitle.Value!, educationOrganizationReference.Value!, schoolYearTypeReference.Value!, rating.Value!, id, ratingDate, ratingOrganization, ratingProgram, etag, ext);
        }
