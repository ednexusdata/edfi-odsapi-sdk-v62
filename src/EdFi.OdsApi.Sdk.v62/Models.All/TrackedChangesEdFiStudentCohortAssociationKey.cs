...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentCohortAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentCohortAssociationKey(DateOnly beginDate = default, string cohortIdentifier = default, int educationOrganizationId = default, string studentUniqueId = default)
        {
