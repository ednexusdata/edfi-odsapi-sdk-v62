...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentCohortAssociationKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiStudentCohortAssociationKey(Option<DateOnly?> beginDate = default, Option<string?> cohortIdentifier = default, Option<int?> educationOrganizationId = default, Option<string?> studentUniqueId = default)
        {
