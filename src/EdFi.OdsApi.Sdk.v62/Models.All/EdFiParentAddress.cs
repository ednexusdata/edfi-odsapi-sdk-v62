...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiParentAddress : IValidatableObject
    {
        ...
        public EdFiParentAddress(string addressTypeDescriptor = default, string stateAbbreviationDescriptor = default, string city = default, string postalCode = default, string streetNumberName = default, string localeDescriptor = default, string apartmentRoomSuiteNumber = default, string buildingSiteNumber = default, string congressionalDistrict = default, string countyFIPSCode = default, bool? doNotPublishIndicator = default, string latitude = default, string longitude = default, string nameOfCounty = default, List<EdFiParentAddressPeriod> periods = default, Object ext = default)
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            if (addressTypeDescriptor == null)
            {
                throw new ArgumentNullException("addressTypeDescriptor is a required property for EdFiParentAddress and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("stateAbbreviationDescriptor is a required property for EdFiParentAddress and cannot be null");
            }
            this.StateAbbreviationDescriptor = stateAbbreviationDescriptor;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for EdFiParentAddress and cannot be null");
            }
            this.City = city;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for EdFiParentAddress and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "streetNumberName" is required (not null)
            if (streetNumberName == null)
            {
                throw new ArgumentNullException("streetNumberName is a required property for EdFiParentAddress and cannot be null");
            }
