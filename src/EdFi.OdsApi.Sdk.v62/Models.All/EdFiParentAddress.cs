...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    /// EdFiParentAddress
    /// </summary>
    public partial class EdFiParentAddress : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ext">Extensions to the ParentAddress entity.</param>
        [JsonConstructor]
        public EdFiParentAddress(string addressTypeDescriptor, string stateAbbreviationDescriptor, string city, string postalCode, string streetNumberName, Option<string?> localeDescriptor = default, Option<string?> apartmentRoomSuiteNumber = default, Option<string?> buildingSiteNumber = default, Option<string?> congressionalDistrict = default, Option<string?> countyFIPSCode = default, Option<bool?> doNotPublishIndicator = default, Option<string?> latitude = default, Option<string?> longitude = default, Option<string?> nameOfCounty = default, Option<List<EdFiParentAddressPeriod>?> periods = default, Option<Object?> ext = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EdFiParentAddressPeriod>?> PeriodsOption { get; private set; }
        ...
        public List<EdFiParentAddressPeriod>? Periods { get { return this.PeriodsOption; } set { this.PeriodsOption = new(value); } }
        ...
        /// <summary>
        /// Extensions to the ParentAddress entity.
        /// </summary>
        /// <value>Extensions to the ParentAddress entity.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="EdFiParentAddress" />
    /// </summary>
    public class EdFiParentAddressJsonConverter : JsonConverter<EdFiParentAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="EdFiParentAddress" />
        /// </summary>
        ...
        public override EdFiParentAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EdFiParentAddressPeriod>?> periods = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "nameOfCounty":
                            ...
                            break;
                        case "periods":
                            periods = new Option<List<EdFiParentAddressPeriod>?>(JsonSerializer.Deserialize<List<EdFiParentAddressPeriod>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "_ext":
            ...
            if (!addressTypeDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentAddress.", nameof(addressTypeDescriptor));

            if (!stateAbbreviationDescriptor.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentAddress.", nameof(stateAbbreviationDescriptor));

            if (!city.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentAddress.", nameof(city));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentAddress.", nameof(postalCode));

            if (!streetNumberName.IsSet)
                throw new ArgumentException("Property is required for class EdFiParentAddress.", nameof(streetNumberName));

            if (addressTypeDescriptor.IsSet && addressTypeDescriptor.Value == null)
                throw new ArgumentNullException(nameof(addressTypeDescriptor), "Property is not nullable for class EdFiParentAddress.");

            if (stateAbbreviationDescriptor.IsSet && stateAbbreviationDescriptor.Value == null)
                throw new ArgumentNullException(nameof(stateAbbreviationDescriptor), "Property is not nullable for class EdFiParentAddress.");

            if (city.IsSet && city.Value == null)
                throw new ArgumentNullException(nameof(city), "Property is not nullable for class EdFiParentAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class EdFiParentAddress.");

            if (streetNumberName.IsSet && streetNumberName.Value == null)
                throw new ArgumentNullException(nameof(streetNumberName), "Property is not nullable for class EdFiParentAddress.");

            if (periods.IsSet && periods.Value == null)
                throw new ArgumentNullException(nameof(periods), "Property is not nullable for class EdFiParentAddress.");

            if (ext.IsSet && ext.Value == null)
                throw new ArgumentNullException(nameof(ext), "Property is not nullable for class EdFiParentAddress.");

            return new EdFiParentAddress(addressTypeDescriptor.Value!, stateAbbreviationDescriptor.Value!, city.Value!, postalCode.Value!, streetNumberName.Value!, localeDescriptor, apartmentRoomSuiteNumber, buildingSiteNumber, congressionalDistrict, countyFIPSCode, doNotPublishIndicator, latitude, longitude, nameOfCounty, periods, ext);
        }

        /// <summary>
        /// Serializes a <see cref="EdFiParentAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiParentAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EdFiParentAddress edFiParentAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, edFiParentAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EdFiParentAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="edFiParentAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EdFiParentAddress edFiParentAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (edFiParentAddress.AddressTypeDescriptor == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.AddressTypeDescriptor), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.StateAbbreviationDescriptor == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.StateAbbreviationDescriptor), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.City == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.City), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.PostalCode), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.StreetNumberName == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.StreetNumberName), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.PeriodsOption.IsSet && edFiParentAddress.Periods == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.Periods), "Property is required for class EdFiParentAddress.");

            if (edFiParentAddress.ExtOption.IsSet && edFiParentAddress.Ext == null)
                throw new ArgumentNullException(nameof(edFiParentAddress.Ext), "Property is required for class EdFiParentAddress.");

            writer.WriteString("addressTypeDescriptor", edFiParentAddress.AddressTypeDescriptor);

            writer.WriteString("stateAbbreviationDescriptor", edFiParentAddress.StateAbbreviationDescriptor);

            writer.WriteString("city", edFiParentAddress.City);

            writer.WriteString("postalCode", edFiParentAddress.PostalCode);

            writer.WriteString("streetNumberName", edFiParentAddress.StreetNumberName);

            if (edFiParentAddress.LocaleDescriptorOption.IsSet)
                if (edFiParentAddress.LocaleDescriptorOption.Value != null)
                    writer.WriteString("localeDescriptor", edFiParentAddress.LocaleDescriptor);
                else
                    writer.WriteNull("localeDescriptor");

            if (edFiParentAddress.ApartmentRoomSuiteNumberOption.IsSet)
                if (edFiParentAddress.ApartmentRoomSuiteNumberOption.Value != null)
                    writer.WriteString("apartmentRoomSuiteNumber", edFiParentAddress.ApartmentRoomSuiteNumber);
                else
                    writer.WriteNull("apartmentRoomSuiteNumber");

            if (edFiParentAddress.BuildingSiteNumberOption.IsSet)
                if (edFiParentAddress.BuildingSiteNumberOption.Value != null)
                    writer.WriteString("buildingSiteNumber", edFiParentAddress.BuildingSiteNumber);
                else
                    writer.WriteNull("buildingSiteNumber");

            if (edFiParentAddress.CongressionalDistrictOption.IsSet)
                if (edFiParentAddress.CongressionalDistrictOption.Value != null)
                    writer.WriteString("congressionalDistrict", edFiParentAddress.CongressionalDistrict);
                else
                    writer.WriteNull("congressionalDistrict");

            if (edFiParentAddress.CountyFIPSCodeOption.IsSet)
                if (edFiParentAddress.CountyFIPSCodeOption.Value != null)
                    writer.WriteString("countyFIPSCode", edFiParentAddress.CountyFIPSCode);
                else
                    writer.WriteNull("countyFIPSCode");

            if (edFiParentAddress.DoNotPublishIndicatorOption.IsSet)
                if (edFiParentAddress.DoNotPublishIndicatorOption.Value != null)
                    writer.WriteBoolean("doNotPublishIndicator", edFiParentAddress.DoNotPublishIndicatorOption.Value!.Value);
                else
                    writer.WriteNull("doNotPublishIndicator");

            if (edFiParentAddress.LatitudeOption.IsSet)
                if (edFiParentAddress.LatitudeOption.Value != null)
                    writer.WriteString("latitude", edFiParentAddress.Latitude);
                else
                    writer.WriteNull("latitude");

            if (edFiParentAddress.LongitudeOption.IsSet)
                if (edFiParentAddress.LongitudeOption.Value != null)
                    writer.WriteString("longitude", edFiParentAddress.Longitude);
                else
                    writer.WriteNull("longitude");

            if (edFiParentAddress.NameOfCountyOption.IsSet)
                if (edFiParentAddress.NameOfCountyOption.Value != null)
                    writer.WriteString("nameOfCounty", edFiParentAddress.NameOfCounty);
                else
                    writer.WriteNull("nameOfCounty");

            if (edFiParentAddress.PeriodsOption.IsSet)
            {
                writer.WritePropertyName("periods");
                JsonSerializer.Serialize(writer, edFiParentAddress.Periods, jsonSerializerOptions);
            }
            if (edFiParentAddress.ExtOption.IsSet)
            {
                writer.WritePropertyName("_ext");
                JsonSerializer.Serialize(writer, edFiParentAddress.Ext, jsonSerializerOptions);
            }
        }
    }
}
