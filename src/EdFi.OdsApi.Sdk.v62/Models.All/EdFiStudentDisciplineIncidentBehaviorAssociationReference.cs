...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiStudentDisciplineIncidentBehaviorAssociationReference : IValidatableObject
    {
        ...
        public EdFiStudentDisciplineIncidentBehaviorAssociationReference(string behaviorDescriptor = default, string incidentIdentifier = default, int schoolId = default, string studentUniqueId = default, Link link = default)
        {
