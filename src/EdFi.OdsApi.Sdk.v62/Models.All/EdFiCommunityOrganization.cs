...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiCommunityOrganization : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EdFiCommunityOrganization(List<EdFiEducationOrganizationCategory> categories, int communityOrganizationId, string nameOfInstitution, Option<string?> id = default, Option<List<EdFiEducationOrganizationAddress>?> addresses = default, Option<List<EdFiEducationOrganizationIdentificationCode>?> identificationCodes = default, Option<List<EdFiEducationOrganizationIndicator>?> indicators = default, Option<List<EdFiEducationOrganizationInstitutionTelephone>?> institutionTelephones = default, Option<List<EdFiEducationOrganizationInternationalAddress>?> internationalAddresses = default, Option<string?> operationalStatusDescriptor = default, Option<string?> shortNameOfInstitution = default, Option<string?> webSite = default, Option<string?> etag = default, Option<Object?> ext = default)
        {
    ...
    public class EdFiCommunityOrganizationJsonConverter : JsonConverter<EdFiCommunityOrganization>
    {
        ...
        public override EdFiCommunityOrganization Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<int?> communityOrganizationId = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "communityOrganizationId":
                            communityOrganizationId = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
            ...
            return new EdFiCommunityOrganization(categories.Value!, communityOrganizationId.Value!.Value!, nameOfInstitution.Value!, id, addresses, identificationCodes, indicators, institutionTelephones, internationalAddresses, operationalStatusDescriptor, shortNameOfInstitution, webSite, etag, ext);
        }
