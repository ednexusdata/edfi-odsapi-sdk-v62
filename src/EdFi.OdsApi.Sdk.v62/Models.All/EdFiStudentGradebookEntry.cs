...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public class EdFiStudentGradebookEntryJsonConverter : JsonConverter<EdFiStudentGradebookEntry>
    {
        ...
        public override EdFiStudentGradebookEntry Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiStudentGradebookEntry(gradebookEntryReference.Value!, studentReference.Value!, id, assignmentLateStatusDescriptor, competencyLevelDescriptor, dateFulfilled, diagnosticStatement, letterGradeEarned, numericGradeEarned, pointsEarned, submissionStatusDescriptor, timeFulfilled, etag, ext);
        }
