...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentSchoolAttendanceEventKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentSchoolAttendanceEventKey(string attendanceEventCategoryDescriptor = default, DateOnly eventDate = default, int schoolId = default, int schoolYear = default, string sessionName = default, string studentUniqueId = default)
        {
