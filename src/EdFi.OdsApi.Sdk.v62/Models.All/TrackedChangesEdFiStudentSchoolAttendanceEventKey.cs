...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentSchoolAttendanceEventKey : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TrackedChangesEdFiStudentSchoolAttendanceEventKey(Option<string?> attendanceEventCategoryDescriptor = default, Option<DateOnly?> eventDate = default, Option<int?> schoolId = default, Option<int?> schoolYear = default, Option<string?> sessionName = default, Option<string?> studentUniqueId = default)
        {
