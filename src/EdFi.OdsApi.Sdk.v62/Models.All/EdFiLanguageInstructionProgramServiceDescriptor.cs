...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public partial class EdFiLanguageInstructionProgramServiceDescriptor : IValidatableObject
    {
        ...
        public EdFiLanguageInstructionProgramServiceDescriptor(string id = default, int languageInstructionProgramServiceDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, int? priorDescriptorId = default, string shortDescription = default, string etag = default)
        {
