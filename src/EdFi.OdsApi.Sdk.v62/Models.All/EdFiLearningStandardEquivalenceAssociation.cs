...
namespace EdFi.OdsApi.Sdk.v62.Models.All
{
    ...
    public class EdFiLearningStandardEquivalenceAssociationJsonConverter : JsonConverter<EdFiLearningStandardEquivalenceAssociation>
    {
        ...
        public override EdFiLearningStandardEquivalenceAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new EdFiLearningStandardEquivalenceAssociation(varNamespace.Value!, sourceLearningStandardReference.Value!, targetLearningStandardReference.Value!, id, effectiveDate, learningStandardEquivalenceStrengthDescription, learningStandardEquivalenceStrengthDescriptor, etag, ext);
        }
