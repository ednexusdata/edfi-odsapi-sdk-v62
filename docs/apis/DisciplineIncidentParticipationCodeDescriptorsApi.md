# EdFi.OdsApi.Sdk.v62.Apis.All.DisciplineIncidentParticipationCodeDescriptorsApi
...
> List&lt;TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorDelete&gt; DeletesDisciplineIncidentParticipationCodeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesDisciplineIncidentParticipationCodeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorDelete> result = apiInstance.DeletesDisciplineIncidentParticipationCodeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorDelete>> response = apiInstance.DeletesDisciplineIncidentParticipationCodeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiDisciplineIncidentParticipationCodeDescriptor>> response = apiInstance.GetDisciplineIncidentParticipationCodeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, disciplineIncidentParticipationCodeDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiDisciplineIncidentParticipationCodeDescriptor> response = apiInstance.GetDisciplineIncidentParticipationCodeDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKeyChange&gt; KeyChangesDisciplineIncidentParticipationCodeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesDisciplineIncidentParticipationCodeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKeyChange> result = apiInstance.KeyChangesDisciplineIncidentParticipationCodeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKeyChange>> response = apiInstance.KeyChangesDisciplineIncidentParticipationCodeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostDisciplineIncidentParticipationCodeDescriptorWithHttpInfo(disciplineIncidentParticipationCodeDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutDisciplineIncidentParticipationCodeDescriptorWithHttpInfo(id, disciplineIncidentParticipationCodeDescriptor, ifMatch);
}
catch (ApiException e)
{
