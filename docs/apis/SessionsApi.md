# EdFi.OdsApi.Sdk.v62.Apis.All.SessionsApi
...
# **DeletesSessions**
> List&lt;TrackedChangesEdFiSessionDelete&gt; DeletesSessions (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesSessionsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiSessionDelete> result = apiInstance.DeletesSessions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiSessionDelete>> response = apiInstance.DeletesSessionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
<a id="getsessions"></a>
# **GetSessions**
> List&lt;EdFiSession&gt; GetSessions (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string sessionName = null, int schoolId = null, int schoolYear = null, string termDescriptor = null, DateOnly beginDate = null, DateOnly endDate = null, string id = null, int totalInstructionalDays = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class GetSessionsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiSession> result = apiInstance.GetSessions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, sessionName, schoolId, schoolYear, termDescriptor, beginDate, endDate, id, totalInstructionalDays, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiSession>> response = apiInstance.GetSessionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, sessionName, schoolId, schoolYear, termDescriptor, beginDate, endDate, id, totalInstructionalDays, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class GetSessionsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiSession result = apiInstance.GetSessionsById(id, ifNoneMatch, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiSession> response = apiInstance.GetSessionsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
# **KeyChangesSessions**
> List&lt;TrackedChangesEdFiSessionKeyChange&gt; KeyChangesSessions (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesSessionsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiSessionKeyChange> result = apiInstance.KeyChangesSessions(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiSessionKeyChange>> response = apiInstance.KeyChangesSessionsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
