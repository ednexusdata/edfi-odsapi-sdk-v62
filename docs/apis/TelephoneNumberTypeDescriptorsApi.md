# EdFi.OdsApi.Sdk.v62.Apis.All.TelephoneNumberTypeDescriptorsApi
...
> List&lt;TrackedChangesEdFiTelephoneNumberTypeDescriptorDelete&gt; DeletesTelephoneNumberTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesTelephoneNumberTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiTelephoneNumberTypeDescriptorDelete> result = apiInstance.DeletesTelephoneNumberTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiTelephoneNumberTypeDescriptorDelete>> response = apiInstance.DeletesTelephoneNumberTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiTelephoneNumberTypeDescriptor>> response = apiInstance.GetTelephoneNumberTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, telephoneNumberTypeDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiTelephoneNumberTypeDescriptor> response = apiInstance.GetTelephoneNumberTypeDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiTelephoneNumberTypeDescriptorKeyChange&gt; KeyChangesTelephoneNumberTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesTelephoneNumberTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiTelephoneNumberTypeDescriptorKeyChange> result = apiInstance.KeyChangesTelephoneNumberTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiTelephoneNumberTypeDescriptorKeyChange>> response = apiInstance.KeyChangesTelephoneNumberTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostTelephoneNumberTypeDescriptorWithHttpInfo(telephoneNumberTypeDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutTelephoneNumberTypeDescriptorWithHttpInfo(id, telephoneNumberTypeDescriptor, ifMatch);
}
catch (ApiException e)
{
