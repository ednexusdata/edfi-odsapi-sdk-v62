# EdFi.OdsApi.Sdk.v62.Apis.All.LocalContractedStaffsApi
...
> List&lt;TrackedChangesEdFiLocalContractedStaffDelete&gt; DeletesLocalContractedStaffs (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesLocalContractedStaffsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiLocalContractedStaffDelete> result = apiInstance.DeletesLocalContractedStaffs(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiLocalContractedStaffDelete>> response = apiInstance.DeletesLocalContractedStaffsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
> List&lt;EdFiLocalContractedStaff&gt; GetLocalContractedStaffs (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, DateOnly asOfDate = null, string accountIdentifier = null, int educationOrganizationId = null, int fiscalYear = null, string staffUniqueId = null, string financialCollectionDescriptor = null, double amount = null, string id = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class GetLocalContractedStaffsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiLocalContractedStaff> result = apiInstance.GetLocalContractedStaffs(offset, limit, minChangeVersion, maxChangeVersion, totalCount, asOfDate, accountIdentifier, educationOrganizationId, fiscalYear, staffUniqueId, financialCollectionDescriptor, amount, id, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiLocalContractedStaff>> response = apiInstance.GetLocalContractedStaffsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, asOfDate, accountIdentifier, educationOrganizationId, fiscalYear, staffUniqueId, financialCollectionDescriptor, amount, id, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> EdFiLocalContractedStaff GetLocalContractedStaffsById (string id, string ifNoneMatch = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class GetLocalContractedStaffsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiLocalContractedStaff result = apiInstance.GetLocalContractedStaffsById(id, ifNoneMatch, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiLocalContractedStaff> response = apiInstance.GetLocalContractedStaffsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiLocalContractedStaffKeyChange&gt; KeyChangesLocalContractedStaffs (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesLocalContractedStaffsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiLocalContractedStaffKeyChange> result = apiInstance.KeyChangesLocalContractedStaffs(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiLocalContractedStaffKeyChange>> response = apiInstance.KeyChangesLocalContractedStaffsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> void PostLocalContractedStaff (EdFiLocalContractedStaff localContractedStaff)
...
namespace Example
{
    public class PostLocalContractedStaffExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new LocalContractedStaffsApi(config);
            var localContractedStaff = new EdFiLocalContractedStaff(); // EdFiLocalContractedStaff | The JSON representation of the \"localContractedStaff\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostLocalContractedStaff(localContractedStaff);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostLocalContractedStaffWithHttpInfo(localContractedStaff);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **localContractedStaff** | [**EdFiLocalContractedStaff**](EdFiLocalContractedStaff.md) | The JSON representation of the \&quot;localContractedStaff\&quot; resource to be created or updated. |  |
...
> void PutLocalContractedStaff (string id, EdFiLocalContractedStaff localContractedStaff, string ifMatch = null)
...
namespace Example
{
    public class PutLocalContractedStaffExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutLocalContractedStaff(id, localContractedStaff, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutLocalContractedStaffWithHttpInfo(id, localContractedStaff, ifMatch);
}
catch (ApiException e)
{
