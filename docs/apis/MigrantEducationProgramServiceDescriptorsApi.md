# EdFi.OdsApi.Sdk.v62.Apis.All.MigrantEducationProgramServiceDescriptorsApi
...
> List&lt;TrackedChangesEdFiMigrantEducationProgramServiceDescriptorDelete&gt; DeletesMigrantEducationProgramServiceDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesMigrantEducationProgramServiceDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiMigrantEducationProgramServiceDescriptorDelete> result = apiInstance.DeletesMigrantEducationProgramServiceDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiMigrantEducationProgramServiceDescriptorDelete>> response = apiInstance.DeletesMigrantEducationProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiMigrantEducationProgramServiceDescriptor>> response = apiInstance.GetMigrantEducationProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, migrantEducationProgramServiceDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiMigrantEducationProgramServiceDescriptor> response = apiInstance.GetMigrantEducationProgramServiceDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiMigrantEducationProgramServiceDescriptorKeyChange&gt; KeyChangesMigrantEducationProgramServiceDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesMigrantEducationProgramServiceDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiMigrantEducationProgramServiceDescriptorKeyChange> result = apiInstance.KeyChangesMigrantEducationProgramServiceDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiMigrantEducationProgramServiceDescriptorKeyChange>> response = apiInstance.KeyChangesMigrantEducationProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostMigrantEducationProgramServiceDescriptorWithHttpInfo(migrantEducationProgramServiceDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutMigrantEducationProgramServiceDescriptorWithHttpInfo(id, migrantEducationProgramServiceDescriptor, ifMatch);
}
catch (ApiException e)
{
