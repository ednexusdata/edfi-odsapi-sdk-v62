# EdFi.OdsApi.Sdk.v62.Apis.All.NeglectedOrDelinquentProgramServiceDescriptorsApi
...
> List&lt;TrackedChangesEdFiNeglectedOrDelinquentProgramServiceDescriptorDelete&gt; DeletesNeglectedOrDelinquentProgramServiceDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesNeglectedOrDelinquentProgramServiceDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiNeglectedOrDelinquentProgramServiceDescriptorDelete> result = apiInstance.DeletesNeglectedOrDelinquentProgramServiceDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiNeglectedOrDelinquentProgramServiceDescriptorDelete>> response = apiInstance.DeletesNeglectedOrDelinquentProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiNeglectedOrDelinquentProgramServiceDescriptor>> response = apiInstance.GetNeglectedOrDelinquentProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, neglectedOrDelinquentProgramServiceDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiNeglectedOrDelinquentProgramServiceDescriptor> response = apiInstance.GetNeglectedOrDelinquentProgramServiceDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiNeglectedOrDelinquentProgramServiceDescriptorKeyChange&gt; KeyChangesNeglectedOrDelinquentProgramServiceDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesNeglectedOrDelinquentProgramServiceDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiNeglectedOrDelinquentProgramServiceDescriptorKeyChange> result = apiInstance.KeyChangesNeglectedOrDelinquentProgramServiceDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiNeglectedOrDelinquentProgramServiceDescriptorKeyChange>> response = apiInstance.KeyChangesNeglectedOrDelinquentProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostNeglectedOrDelinquentProgramServiceDescriptorWithHttpInfo(neglectedOrDelinquentProgramServiceDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutNeglectedOrDelinquentProgramServiceDescriptorWithHttpInfo(id, neglectedOrDelinquentProgramServiceDescriptor, ifMatch);
}
catch (ApiException e)
{
