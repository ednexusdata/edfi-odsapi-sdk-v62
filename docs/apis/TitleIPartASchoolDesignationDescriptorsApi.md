# EdFi.OdsApi.Sdk.v62.Apis.All.TitleIPartASchoolDesignationDescriptorsApi
...
> List&lt;TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorDelete&gt; DeletesTitleIPartASchoolDesignationDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesTitleIPartASchoolDesignationDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorDelete> result = apiInstance.DeletesTitleIPartASchoolDesignationDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorDelete>> response = apiInstance.DeletesTitleIPartASchoolDesignationDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiTitleIPartASchoolDesignationDescriptor>> response = apiInstance.GetTitleIPartASchoolDesignationDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, titleIPartASchoolDesignationDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiTitleIPartASchoolDesignationDescriptor> response = apiInstance.GetTitleIPartASchoolDesignationDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKeyChange&gt; KeyChangesTitleIPartASchoolDesignationDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesTitleIPartASchoolDesignationDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKeyChange> result = apiInstance.KeyChangesTitleIPartASchoolDesignationDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKeyChange>> response = apiInstance.KeyChangesTitleIPartASchoolDesignationDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostTitleIPartASchoolDesignationDescriptorWithHttpInfo(titleIPartASchoolDesignationDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutTitleIPartASchoolDesignationDescriptorWithHttpInfo(id, titleIPartASchoolDesignationDescriptor, ifMatch);
}
catch (ApiException e)
{
