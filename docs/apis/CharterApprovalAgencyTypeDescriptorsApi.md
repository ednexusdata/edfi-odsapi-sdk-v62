# EdFi.OdsApi.Sdk.v62.Apis.All.CharterApprovalAgencyTypeDescriptorsApi
...
> List&lt;TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorDelete&gt; DeletesCharterApprovalAgencyTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesCharterApprovalAgencyTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorDelete> result = apiInstance.DeletesCharterApprovalAgencyTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorDelete>> response = apiInstance.DeletesCharterApprovalAgencyTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiCharterApprovalAgencyTypeDescriptor>> response = apiInstance.GetCharterApprovalAgencyTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, charterApprovalAgencyTypeDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiCharterApprovalAgencyTypeDescriptor> response = apiInstance.GetCharterApprovalAgencyTypeDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKeyChange&gt; KeyChangesCharterApprovalAgencyTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesCharterApprovalAgencyTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKeyChange> result = apiInstance.KeyChangesCharterApprovalAgencyTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKeyChange>> response = apiInstance.KeyChangesCharterApprovalAgencyTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostCharterApprovalAgencyTypeDescriptorWithHttpInfo(charterApprovalAgencyTypeDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutCharterApprovalAgencyTypeDescriptorWithHttpInfo(id, charterApprovalAgencyTypeDescriptor, ifMatch);
}
catch (ApiException e)
{
