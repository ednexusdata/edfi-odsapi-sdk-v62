# EdFi.OdsApi.Sdk.v62.Apis.All.SurveySectionResponsesApi
...
> List&lt;TrackedChangesEdFiSurveySectionResponseDelete&gt; DeletesSurveySectionResponses (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesSurveySectionResponsesExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiSurveySectionResponseDelete> result = apiInstance.DeletesSurveySectionResponses(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiSurveySectionResponseDelete>> response = apiInstance.DeletesSurveySectionResponsesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
namespace Example
{
    public class GetSurveySectionResponsesExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiSurveySectionResponse> result = apiInstance.GetSurveySectionResponses(offset, limit, minChangeVersion, maxChangeVersion, totalCount, varNamespace, surveyIdentifier, surveyResponseIdentifier, surveySectionTitle, id, sectionRating, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiSurveySectionResponse>> response = apiInstance.GetSurveySectionResponsesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, varNamespace, surveyIdentifier, surveyResponseIdentifier, surveySectionTitle, id, sectionRating, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiSurveySectionResponse> response = apiInstance.GetSurveySectionResponsesByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiSurveySectionResponseKeyChange&gt; KeyChangesSurveySectionResponses (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesSurveySectionResponsesExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiSurveySectionResponseKeyChange> result = apiInstance.KeyChangesSurveySectionResponses(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiSurveySectionResponseKeyChange>> response = apiInstance.KeyChangesSurveySectionResponsesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostSurveySectionResponseWithHttpInfo(surveySectionResponse);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutSurveySectionResponseWithHttpInfo(id, surveySectionResponse, ifMatch);
}
catch (ApiException e)
{
