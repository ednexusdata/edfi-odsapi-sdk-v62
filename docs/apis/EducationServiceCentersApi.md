# EdFi.OdsApi.Sdk.v62.Apis.All.EducationServiceCentersApi
...
> List&lt;TrackedChangesEdFiEducationServiceCenterDelete&gt; DeletesEducationServiceCenters (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesEducationServiceCentersExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiEducationServiceCenterDelete> result = apiInstance.DeletesEducationServiceCenters(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiEducationServiceCenterDelete>> response = apiInstance.DeletesEducationServiceCentersWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
namespace Example
{
    public class GetEducationServiceCentersExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiEducationServiceCenter> result = apiInstance.GetEducationServiceCenters(offset, limit, minChangeVersion, maxChangeVersion, totalCount, educationServiceCenterId, stateEducationAgencyId, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiEducationServiceCenter>> response = apiInstance.GetEducationServiceCentersWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, educationServiceCenterId, stateEducationAgencyId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class GetEducationServiceCentersByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiEducationServiceCenter result = apiInstance.GetEducationServiceCentersById(id, ifNoneMatch, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiEducationServiceCenter> response = apiInstance.GetEducationServiceCentersByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiEducationServiceCenterKeyChange&gt; KeyChangesEducationServiceCenters (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesEducationServiceCentersExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiEducationServiceCenterKeyChange> result = apiInstance.KeyChangesEducationServiceCenters(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiEducationServiceCenterKeyChange>> response = apiInstance.KeyChangesEducationServiceCentersWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostEducationServiceCenterWithHttpInfo(educationServiceCenter);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutEducationServiceCenterWithHttpInfo(id, educationServiceCenter, ifMatch);
}
catch (ApiException e)
{
