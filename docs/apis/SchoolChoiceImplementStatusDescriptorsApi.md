# EdFi.OdsApi.Sdk.v62.Apis.All.SchoolChoiceImplementStatusDescriptorsApi
...
> List&lt;TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorDelete&gt; DeletesSchoolChoiceImplementStatusDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesSchoolChoiceImplementStatusDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorDelete> result = apiInstance.DeletesSchoolChoiceImplementStatusDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorDelete>> response = apiInstance.DeletesSchoolChoiceImplementStatusDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiSchoolChoiceImplementStatusDescriptor>> response = apiInstance.GetSchoolChoiceImplementStatusDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, schoolChoiceImplementStatusDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiSchoolChoiceImplementStatusDescriptor> response = apiInstance.GetSchoolChoiceImplementStatusDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorKeyChange&gt; KeyChangesSchoolChoiceImplementStatusDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesSchoolChoiceImplementStatusDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorKeyChange> result = apiInstance.KeyChangesSchoolChoiceImplementStatusDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorKeyChange>> response = apiInstance.KeyChangesSchoolChoiceImplementStatusDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostSchoolChoiceImplementStatusDescriptorWithHttpInfo(schoolChoiceImplementStatusDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutSchoolChoiceImplementStatusDescriptorWithHttpInfo(id, schoolChoiceImplementStatusDescriptor, ifMatch);
}
catch (ApiException e)
{
