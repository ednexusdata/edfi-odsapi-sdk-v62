# EdFi.OdsApi.Sdk.v62.Apis.All.CourseGPAApplicabilityDescriptorsApi
...
> List&lt;TrackedChangesEdFiCourseGPAApplicabilityDescriptorDelete&gt; DeletesCourseGPAApplicabilityDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesCourseGPAApplicabilityDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiCourseGPAApplicabilityDescriptorDelete> result = apiInstance.DeletesCourseGPAApplicabilityDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiCourseGPAApplicabilityDescriptorDelete>> response = apiInstance.DeletesCourseGPAApplicabilityDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiCourseGPAApplicabilityDescriptor>> response = apiInstance.GetCourseGPAApplicabilityDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, courseGPAApplicabilityDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiCourseGPAApplicabilityDescriptor> response = apiInstance.GetCourseGPAApplicabilityDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiCourseGPAApplicabilityDescriptorKeyChange&gt; KeyChangesCourseGPAApplicabilityDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesCourseGPAApplicabilityDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiCourseGPAApplicabilityDescriptorKeyChange> result = apiInstance.KeyChangesCourseGPAApplicabilityDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiCourseGPAApplicabilityDescriptorKeyChange>> response = apiInstance.KeyChangesCourseGPAApplicabilityDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostCourseGPAApplicabilityDescriptorWithHttpInfo(courseGPAApplicabilityDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutCourseGPAApplicabilityDescriptorWithHttpInfo(id, courseGPAApplicabilityDescriptor, ifMatch);
}
catch (ApiException e)
{
