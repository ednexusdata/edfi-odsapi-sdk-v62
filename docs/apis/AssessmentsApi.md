# EdFi.OdsApi.Sdk.v62.Apis.All.AssessmentsApi
...
# **DeletesAssessments**
> List&lt;TrackedChangesEdFiAssessmentDelete&gt; DeletesAssessments (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesAssessmentsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiAssessmentDelete> result = apiInstance.DeletesAssessments(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiAssessmentDelete>> response = apiInstance.DeletesAssessmentsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
# **GetAssessments**
> List&lt;EdFiAssessment&gt; GetAssessments (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string assessmentIdentifier = null, string varNamespace = null, int educationOrganizationId = null, string assessmentCategoryDescriptor = null, bool adaptiveAssessment = null, string assessmentFamily = null, string assessmentForm = null, string assessmentTitle = null, int assessmentVersion = null, string id = null, double maxRawScore = null, string nomenclature = null, DateOnly revisionDate = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class GetAssessmentsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiAssessment result = apiInstance.GetAssessmentsById(id, ifNoneMatch, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiAssessment> response = apiInstance.GetAssessmentsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiAssessmentKeyChange&gt; KeyChangesAssessments (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesAssessmentsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiAssessmentKeyChange> result = apiInstance.KeyChangesAssessments(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiAssessmentKeyChange>> response = apiInstance.KeyChangesAssessmentsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class PostAssessmentExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AssessmentsApi(config);
            var assessment = new EdFiAssessment(); // EdFiAssessment | The JSON representation of the \"assessment\" resource to be created or updated.
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostAssessmentWithHttpInfo(assessment);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **assessment** | [**EdFiAssessment**](EdFiAssessment.md) | The JSON representation of the \&quot;assessment\&quot; resource to be created or updated. |  |
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutAssessmentWithHttpInfo(id, assessment, ifMatch);
}
catch (ApiException e)
{
