# EdFi.OdsApi.Sdk.v62.Apis.All.AdministrativeFundingControlDescriptorsApi
...
> List&lt;TrackedChangesEdFiAdministrativeFundingControlDescriptorDelete&gt; DeletesAdministrativeFundingControlDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesAdministrativeFundingControlDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiAdministrativeFundingControlDescriptorDelete> result = apiInstance.DeletesAdministrativeFundingControlDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiAdministrativeFundingControlDescriptorDelete>> response = apiInstance.DeletesAdministrativeFundingControlDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiAdministrativeFundingControlDescriptor>> response = apiInstance.GetAdministrativeFundingControlDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, administrativeFundingControlDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiAdministrativeFundingControlDescriptor> response = apiInstance.GetAdministrativeFundingControlDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiAdministrativeFundingControlDescriptorKeyChange&gt; KeyChangesAdministrativeFundingControlDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesAdministrativeFundingControlDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiAdministrativeFundingControlDescriptorKeyChange> result = apiInstance.KeyChangesAdministrativeFundingControlDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiAdministrativeFundingControlDescriptorKeyChange>> response = apiInstance.KeyChangesAdministrativeFundingControlDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostAdministrativeFundingControlDescriptorWithHttpInfo(administrativeFundingControlDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutAdministrativeFundingControlDescriptorWithHttpInfo(id, administrativeFundingControlDescriptor, ifMatch);
}
catch (ApiException e)
{
