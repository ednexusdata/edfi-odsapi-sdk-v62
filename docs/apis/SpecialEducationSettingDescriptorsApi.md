# EdFi.OdsApi.Sdk.v62.Apis.All.SpecialEducationSettingDescriptorsApi
...
> List&lt;TrackedChangesEdFiSpecialEducationSettingDescriptorDelete&gt; DeletesSpecialEducationSettingDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesSpecialEducationSettingDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiSpecialEducationSettingDescriptorDelete> result = apiInstance.DeletesSpecialEducationSettingDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiSpecialEducationSettingDescriptorDelete>> response = apiInstance.DeletesSpecialEducationSettingDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiSpecialEducationSettingDescriptor>> response = apiInstance.GetSpecialEducationSettingDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, specialEducationSettingDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiSpecialEducationSettingDescriptor> response = apiInstance.GetSpecialEducationSettingDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiSpecialEducationSettingDescriptorKeyChange&gt; KeyChangesSpecialEducationSettingDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesSpecialEducationSettingDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiSpecialEducationSettingDescriptorKeyChange> result = apiInstance.KeyChangesSpecialEducationSettingDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiSpecialEducationSettingDescriptorKeyChange>> response = apiInstance.KeyChangesSpecialEducationSettingDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostSpecialEducationSettingDescriptorWithHttpInfo(specialEducationSettingDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutSpecialEducationSettingDescriptorWithHttpInfo(id, specialEducationSettingDescriptor, ifMatch);
}
catch (ApiException e)
{
