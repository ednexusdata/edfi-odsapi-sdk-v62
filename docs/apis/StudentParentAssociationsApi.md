# EdFi.OdsApi.Sdk.v62.Apis.All.StudentParentAssociationsApi
...
| [**KeyChangesStudentParentAssociations**](StudentParentAssociationsApi.md#keychangesstudentparentassociations) | **GET** /ed-fi/studentParentAssociations/keyChanges | Retrieves resources key changes based on change version. |
...
> List&lt;TrackedChangesEdFiStudentParentAssociationDelete&gt; DeletesStudentParentAssociations (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesStudentParentAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiStudentParentAssociationDelete> result = apiInstance.DeletesStudentParentAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiStudentParentAssociationDelete>> response = apiInstance.DeletesStudentParentAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
[**List&lt;TrackedChangesEdFiStudentParentAssociationDelete&gt;**](TrackedChangesEdFiStudentParentAssociationDelete.md)
...
<a id="keychangesstudentparentassociations"></a>
# **KeyChangesStudentParentAssociations**
> List&lt;TrackedChangesEdFiStudentParentAssociationKeyChange&gt; KeyChangesStudentParentAssociations (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesStudentParentAssociationsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiStudentParentAssociationKeyChange> result = apiInstance.KeyChangesStudentParentAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling StudentParentAssociationsApi.KeyChangesStudentParentAssociations: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the KeyChangesStudentParentAssociationsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiStudentParentAssociationKeyChange>> response = apiInstance.KeyChangesStudentParentAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling StudentParentAssociationsApi.KeyChangesStudentParentAssociationsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
[**List&lt;TrackedChangesEdFiStudentParentAssociationKeyChange&gt;**](TrackedChangesEdFiStudentParentAssociationKeyChange.md)
