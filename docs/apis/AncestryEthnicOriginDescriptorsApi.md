# EdFi.OdsApi.Sdk.v62.Apis.All.AncestryEthnicOriginDescriptorsApi
...
> List&lt;TrackedChangesEdFiAncestryEthnicOriginDescriptorDelete&gt; DeletesAncestryEthnicOriginDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesAncestryEthnicOriginDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiAncestryEthnicOriginDescriptorDelete> result = apiInstance.DeletesAncestryEthnicOriginDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiAncestryEthnicOriginDescriptorDelete>> response = apiInstance.DeletesAncestryEthnicOriginDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiAncestryEthnicOriginDescriptor>> response = apiInstance.GetAncestryEthnicOriginDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, ancestryEthnicOriginDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiAncestryEthnicOriginDescriptor> response = apiInstance.GetAncestryEthnicOriginDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiAncestryEthnicOriginDescriptorKeyChange&gt; KeyChangesAncestryEthnicOriginDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesAncestryEthnicOriginDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiAncestryEthnicOriginDescriptorKeyChange> result = apiInstance.KeyChangesAncestryEthnicOriginDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiAncestryEthnicOriginDescriptorKeyChange>> response = apiInstance.KeyChangesAncestryEthnicOriginDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostAncestryEthnicOriginDescriptorWithHttpInfo(ancestryEthnicOriginDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutAncestryEthnicOriginDescriptorWithHttpInfo(id, ancestryEthnicOriginDescriptor, ifMatch);
}
catch (ApiException e)
{
