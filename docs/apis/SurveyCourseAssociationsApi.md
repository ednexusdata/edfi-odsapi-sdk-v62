# EdFi.OdsApi.Sdk.v62.Apis.All.SurveyCourseAssociationsApi
...
> List&lt;TrackedChangesEdFiSurveyCourseAssociationDelete&gt; DeletesSurveyCourseAssociations (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesSurveyCourseAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiSurveyCourseAssociationDelete> result = apiInstance.DeletesSurveyCourseAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiSurveyCourseAssociationDelete>> response = apiInstance.DeletesSurveyCourseAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
> List&lt;EdFiSurveyCourseAssociation&gt; GetSurveyCourseAssociations (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string courseCode = null, int educationOrganizationId = null, string varNamespace = null, string surveyIdentifier = null, string id = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class GetSurveyCourseAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiSurveyCourseAssociation> result = apiInstance.GetSurveyCourseAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, courseCode, educationOrganizationId, varNamespace, surveyIdentifier, id, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiSurveyCourseAssociation>> response = apiInstance.GetSurveyCourseAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, courseCode, educationOrganizationId, varNamespace, surveyIdentifier, id, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiSurveyCourseAssociation> response = apiInstance.GetSurveyCourseAssociationsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiSurveyCourseAssociationKeyChange&gt; KeyChangesSurveyCourseAssociations (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesSurveyCourseAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiSurveyCourseAssociationKeyChange> result = apiInstance.KeyChangesSurveyCourseAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiSurveyCourseAssociationKeyChange>> response = apiInstance.KeyChangesSurveyCourseAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostSurveyCourseAssociationWithHttpInfo(surveyCourseAssociation);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutSurveyCourseAssociationWithHttpInfo(id, surveyCourseAssociation, ifMatch);
}
catch (ApiException e)
{
