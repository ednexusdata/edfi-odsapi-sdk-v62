# EdFi.OdsApi.Sdk.v62.Apis.All.StudentProgramAttendanceEventsApi
...
> List&lt;TrackedChangesEdFiStudentProgramAttendanceEventDelete&gt; DeletesStudentProgramAttendanceEvents (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesStudentProgramAttendanceEventsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiStudentProgramAttendanceEventDelete> result = apiInstance.DeletesStudentProgramAttendanceEvents(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiStudentProgramAttendanceEventDelete>> response = apiInstance.DeletesStudentProgramAttendanceEventsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiStudentProgramAttendanceEvent> response = apiInstance.GetStudentProgramAttendanceEventsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiStudentProgramAttendanceEventKeyChange&gt; KeyChangesStudentProgramAttendanceEvents (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesStudentProgramAttendanceEventsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiStudentProgramAttendanceEventKeyChange> result = apiInstance.KeyChangesStudentProgramAttendanceEvents(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiStudentProgramAttendanceEventKeyChange>> response = apiInstance.KeyChangesStudentProgramAttendanceEventsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostStudentProgramAttendanceEventWithHttpInfo(studentProgramAttendanceEvent);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutStudentProgramAttendanceEventWithHttpInfo(id, studentProgramAttendanceEvent, ifMatch);
}
catch (ApiException e)
{
