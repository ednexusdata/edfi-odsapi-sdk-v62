# EdFi.OdsApi.Sdk.v62.Apis.All.LocalBudgetsApi
...
# **DeletesLocalBudgets**
> List&lt;TrackedChangesEdFiLocalBudgetDelete&gt; DeletesLocalBudgets (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesLocalBudgetsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiLocalBudgetDelete> result = apiInstance.DeletesLocalBudgets(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiLocalBudgetDelete>> response = apiInstance.DeletesLocalBudgetsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
namespace Example
{
    public class GetLocalBudgetsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiLocalBudget> result = apiInstance.GetLocalBudgets(offset, limit, minChangeVersion, maxChangeVersion, totalCount, asOfDate, accountIdentifier, educationOrganizationId, fiscalYear, financialCollectionDescriptor, amount, id, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiLocalBudget>> response = apiInstance.GetLocalBudgetsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, asOfDate, accountIdentifier, educationOrganizationId, fiscalYear, financialCollectionDescriptor, amount, id, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
# **GetLocalBudgetsById**
> EdFiLocalBudget GetLocalBudgetsById (string id, string ifNoneMatch = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class GetLocalBudgetsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiLocalBudget result = apiInstance.GetLocalBudgetsById(id, ifNoneMatch, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiLocalBudget> response = apiInstance.GetLocalBudgetsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiLocalBudgetKeyChange&gt; KeyChangesLocalBudgets (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesLocalBudgetsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiLocalBudgetKeyChange> result = apiInstance.KeyChangesLocalBudgets(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiLocalBudgetKeyChange>> response = apiInstance.KeyChangesLocalBudgetsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
# **PostLocalBudget**
> void PostLocalBudget (EdFiLocalBudget localBudget)
...
namespace Example
{
    public class PostLocalBudgetExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new LocalBudgetsApi(config);
            var localBudget = new EdFiLocalBudget(); // EdFiLocalBudget | The JSON representation of the \"localBudget\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostLocalBudget(localBudget);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostLocalBudgetWithHttpInfo(localBudget);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **localBudget** | [**EdFiLocalBudget**](EdFiLocalBudget.md) | The JSON representation of the \&quot;localBudget\&quot; resource to be created or updated. |  |
...
# **PutLocalBudget**
> void PutLocalBudget (string id, EdFiLocalBudget localBudget, string ifMatch = null)
...
namespace Example
{
    public class PutLocalBudgetExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutLocalBudget(id, localBudget, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutLocalBudgetWithHttpInfo(id, localBudget, ifMatch);
}
catch (ApiException e)
{
