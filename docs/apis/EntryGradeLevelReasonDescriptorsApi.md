# EdFi.OdsApi.Sdk.v62.Apis.All.EntryGradeLevelReasonDescriptorsApi
...
> List&lt;TrackedChangesEdFiEntryGradeLevelReasonDescriptorDelete&gt; DeletesEntryGradeLevelReasonDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesEntryGradeLevelReasonDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiEntryGradeLevelReasonDescriptorDelete> result = apiInstance.DeletesEntryGradeLevelReasonDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiEntryGradeLevelReasonDescriptorDelete>> response = apiInstance.DeletesEntryGradeLevelReasonDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiEntryGradeLevelReasonDescriptor>> response = apiInstance.GetEntryGradeLevelReasonDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, entryGradeLevelReasonDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiEntryGradeLevelReasonDescriptor> response = apiInstance.GetEntryGradeLevelReasonDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiEntryGradeLevelReasonDescriptorKeyChange&gt; KeyChangesEntryGradeLevelReasonDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesEntryGradeLevelReasonDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiEntryGradeLevelReasonDescriptorKeyChange> result = apiInstance.KeyChangesEntryGradeLevelReasonDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiEntryGradeLevelReasonDescriptorKeyChange>> response = apiInstance.KeyChangesEntryGradeLevelReasonDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostEntryGradeLevelReasonDescriptorWithHttpInfo(entryGradeLevelReasonDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutEntryGradeLevelReasonDescriptorWithHttpInfo(id, entryGradeLevelReasonDescriptor, ifMatch);
}
catch (ApiException e)
{
