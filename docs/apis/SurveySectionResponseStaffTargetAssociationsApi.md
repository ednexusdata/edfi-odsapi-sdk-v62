# EdFi.OdsApi.Sdk.v62.Apis.All.SurveySectionResponseStaffTargetAssociationsApi
...
> List&lt;TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationDelete&gt; DeletesSurveySectionResponseStaffTargetAssociations (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesSurveySectionResponseStaffTargetAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationDelete> result = apiInstance.DeletesSurveySectionResponseStaffTargetAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationDelete>> response = apiInstance.DeletesSurveySectionResponseStaffTargetAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
namespace Example
{
    public class GetSurveySectionResponseStaffTargetAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiSurveySectionResponseStaffTargetAssociation> result = apiInstance.GetSurveySectionResponseStaffTargetAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, staffUniqueId, varNamespace, surveyIdentifier, surveyResponseIdentifier, surveySectionTitle, id, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
namespace Example
{
    public class GetSurveySectionResponseStaffTargetAssociationsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiSurveySectionResponseStaffTargetAssociation result = apiInstance.GetSurveySectionResponseStaffTargetAssociationsById(id, ifNoneMatch, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiSurveySectionResponseStaffTargetAssociation> response = apiInstance.GetSurveySectionResponseStaffTargetAssociationsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKeyChange&gt; KeyChangesSurveySectionResponseStaffTargetAssociations (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesSurveySectionResponseStaffTargetAssociationsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKeyChange> result = apiInstance.KeyChangesSurveySectionResponseStaffTargetAssociations(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKeyChange>> response = apiInstance.KeyChangesSurveySectionResponseStaffTargetAssociationsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class PostSurveySectionResponseStaffTargetAssociationExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new SurveySectionResponseStaffTargetAssociationsApi(config);
            var surveySectionResponseStaffTargetAssociation = new EdFiSurveySectionResponseStaffTargetAssociation(); // EdFiSurveySectionResponseStaffTargetAssociation | The JSON representation of the \"surveySectionResponseStaffTargetAssociation\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostSurveySectionResponseStaffTargetAssociation(surveySectionResponseStaffTargetAssociation);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostSurveySectionResponseStaffTargetAssociationWithHttpInfo(surveySectionResponseStaffTargetAssociation);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **surveySectionResponseStaffTargetAssociation** | [**EdFiSurveySectionResponseStaffTargetAssociation**](EdFiSurveySectionResponseStaffTargetAssociation.md) | The JSON representation of the \&quot;surveySectionResponseStaffTargetAssociation\&quot; resource to be created or updated. |  |
...
namespace Example
{
    public class PutSurveySectionResponseStaffTargetAssociationExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutSurveySectionResponseStaffTargetAssociation(id, surveySectionResponseStaffTargetAssociation, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutSurveySectionResponseStaffTargetAssociationWithHttpInfo(id, surveySectionResponseStaffTargetAssociation, ifMatch);
}
catch (ApiException e)
{
