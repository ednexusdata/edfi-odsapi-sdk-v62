# EdFi.OdsApi.Sdk.v62.Apis.All.AssessmentIdentificationSystemDescriptorsApi
...
> List&lt;TrackedChangesEdFiAssessmentIdentificationSystemDescriptorDelete&gt; DeletesAssessmentIdentificationSystemDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesAssessmentIdentificationSystemDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiAssessmentIdentificationSystemDescriptorDelete> result = apiInstance.DeletesAssessmentIdentificationSystemDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiAssessmentIdentificationSystemDescriptorDelete>> response = apiInstance.DeletesAssessmentIdentificationSystemDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiAssessmentIdentificationSystemDescriptor>> response = apiInstance.GetAssessmentIdentificationSystemDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, assessmentIdentificationSystemDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiAssessmentIdentificationSystemDescriptor> response = apiInstance.GetAssessmentIdentificationSystemDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiAssessmentIdentificationSystemDescriptorKeyChange&gt; KeyChangesAssessmentIdentificationSystemDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesAssessmentIdentificationSystemDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiAssessmentIdentificationSystemDescriptorKeyChange> result = apiInstance.KeyChangesAssessmentIdentificationSystemDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiAssessmentIdentificationSystemDescriptorKeyChange>> response = apiInstance.KeyChangesAssessmentIdentificationSystemDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostAssessmentIdentificationSystemDescriptorWithHttpInfo(assessmentIdentificationSystemDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutAssessmentIdentificationSystemDescriptorWithHttpInfo(id, assessmentIdentificationSystemDescriptor, ifMatch);
}
catch (ApiException e)
{
