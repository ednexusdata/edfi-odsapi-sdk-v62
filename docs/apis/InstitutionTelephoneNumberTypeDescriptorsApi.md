# EdFi.OdsApi.Sdk.v62.Apis.All.InstitutionTelephoneNumberTypeDescriptorsApi
...
> List&lt;TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorDelete&gt; DeletesInstitutionTelephoneNumberTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesInstitutionTelephoneNumberTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorDelete> result = apiInstance.DeletesInstitutionTelephoneNumberTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorDelete>> response = apiInstance.DeletesInstitutionTelephoneNumberTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiInstitutionTelephoneNumberTypeDescriptor>> response = apiInstance.GetInstitutionTelephoneNumberTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, institutionTelephoneNumberTypeDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiInstitutionTelephoneNumberTypeDescriptor> response = apiInstance.GetInstitutionTelephoneNumberTypeDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKeyChange&gt; KeyChangesInstitutionTelephoneNumberTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesInstitutionTelephoneNumberTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKeyChange> result = apiInstance.KeyChangesInstitutionTelephoneNumberTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKeyChange>> response = apiInstance.KeyChangesInstitutionTelephoneNumberTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostInstitutionTelephoneNumberTypeDescriptorWithHttpInfo(institutionTelephoneNumberTypeDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutInstitutionTelephoneNumberTypeDescriptorWithHttpInfo(id, institutionTelephoneNumberTypeDescriptor, ifMatch);
}
catch (ApiException e)
{
