# EdFi.OdsApi.Sdk.v62.Apis.All.SurveyResponsesApi
...
> List&lt;TrackedChangesEdFiSurveyResponseDelete&gt; DeletesSurveyResponses (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesSurveyResponsesExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiSurveyResponseDelete> result = apiInstance.DeletesSurveyResponses(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiSurveyResponseDelete>> response = apiInstance.DeletesSurveyResponsesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
# **GetSurveyResponses**
> List&lt;EdFiSurveyResponse&gt; GetSurveyResponses (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string surveyResponseIdentifier = null, string varNamespace = null, string surveyIdentifier = null, string parentUniqueId = null, string staffUniqueId = null, string studentUniqueId = null, string electronicMailAddress = null, string fullName = null, string id = null, string location = null, DateOnly responseDate = null, int responseTime = null, string snapshotIdentifier = null)
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiSurveyResponse> response = apiInstance.GetSurveyResponsesByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiSurveyResponseKeyChange&gt; KeyChangesSurveyResponses (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesSurveyResponsesExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiSurveyResponseKeyChange> result = apiInstance.KeyChangesSurveyResponses(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiSurveyResponseKeyChange>> response = apiInstance.KeyChangesSurveyResponsesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostSurveyResponseWithHttpInfo(surveyResponse);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutSurveyResponseWithHttpInfo(id, surveyResponse, ifMatch);
}
catch (ApiException e)
{
