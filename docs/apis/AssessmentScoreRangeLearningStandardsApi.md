# EdFi.OdsApi.Sdk.v62.Apis.All.AssessmentScoreRangeLearningStandardsApi
...
> List&lt;TrackedChangesEdFiAssessmentScoreRangeLearningStandardDelete&gt; DeletesAssessmentScoreRangeLearningStandards (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesAssessmentScoreRangeLearningStandardsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiAssessmentScoreRangeLearningStandardDelete> result = apiInstance.DeletesAssessmentScoreRangeLearningStandards(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiAssessmentScoreRangeLearningStandardDelete>> response = apiInstance.DeletesAssessmentScoreRangeLearningStandardsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
> List&lt;EdFiAssessmentScoreRangeLearningStandard&gt; GetAssessmentScoreRangeLearningStandards (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string scoreRangeId = null, string assessmentIdentifier = null, string varNamespace = null, string identificationCode = null, string assessmentReportingMethodDescriptor = null, string id = null, string maximumScore = null, string minimumScore = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class GetAssessmentScoreRangeLearningStandardsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiAssessmentScoreRangeLearningStandard> result = apiInstance.GetAssessmentScoreRangeLearningStandards(offset, limit, minChangeVersion, maxChangeVersion, totalCount, scoreRangeId, assessmentIdentifier, varNamespace, identificationCode, assessmentReportingMethodDescriptor, id, maximumScore, minimumScore, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiAssessmentScoreRangeLearningStandard> response = apiInstance.GetAssessmentScoreRangeLearningStandardsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiAssessmentScoreRangeLearningStandardKeyChange&gt; KeyChangesAssessmentScoreRangeLearningStandards (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesAssessmentScoreRangeLearningStandardsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiAssessmentScoreRangeLearningStandardKeyChange> result = apiInstance.KeyChangesAssessmentScoreRangeLearningStandards(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiAssessmentScoreRangeLearningStandardKeyChange>> response = apiInstance.KeyChangesAssessmentScoreRangeLearningStandardsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostAssessmentScoreRangeLearningStandardWithHttpInfo(assessmentScoreRangeLearningStandard);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutAssessmentScoreRangeLearningStandardWithHttpInfo(id, assessmentScoreRangeLearningStandard, ifMatch);
}
catch (ApiException e)
{
