# EdFi.OdsApi.Sdk.v62.Apis.All.LearningStandardScopeDescriptorsApi
...
> List&lt;TrackedChangesEdFiLearningStandardScopeDescriptorDelete&gt; DeletesLearningStandardScopeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesLearningStandardScopeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiLearningStandardScopeDescriptorDelete> result = apiInstance.DeletesLearningStandardScopeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiLearningStandardScopeDescriptorDelete>> response = apiInstance.DeletesLearningStandardScopeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiLearningStandardScopeDescriptor>> response = apiInstance.GetLearningStandardScopeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, learningStandardScopeDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiLearningStandardScopeDescriptor> response = apiInstance.GetLearningStandardScopeDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiLearningStandardScopeDescriptorKeyChange&gt; KeyChangesLearningStandardScopeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesLearningStandardScopeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiLearningStandardScopeDescriptorKeyChange> result = apiInstance.KeyChangesLearningStandardScopeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiLearningStandardScopeDescriptorKeyChange>> response = apiInstance.KeyChangesLearningStandardScopeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostLearningStandardScopeDescriptorWithHttpInfo(learningStandardScopeDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutLearningStandardScopeDescriptorWithHttpInfo(id, learningStandardScopeDescriptor, ifMatch);
}
catch (ApiException e)
{
