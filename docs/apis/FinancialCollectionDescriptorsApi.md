# EdFi.OdsApi.Sdk.v62.Apis.All.FinancialCollectionDescriptorsApi
...
> List&lt;TrackedChangesEdFiFinancialCollectionDescriptorDelete&gt; DeletesFinancialCollectionDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesFinancialCollectionDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiFinancialCollectionDescriptorDelete> result = apiInstance.DeletesFinancialCollectionDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiFinancialCollectionDescriptorDelete>> response = apiInstance.DeletesFinancialCollectionDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
> List&lt;EdFiFinancialCollectionDescriptor&gt; GetFinancialCollectionDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int financialCollectionDescriptorId = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class GetFinancialCollectionDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiFinancialCollectionDescriptor> result = apiInstance.GetFinancialCollectionDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, financialCollectionDescriptorId, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiFinancialCollectionDescriptor>> response = apiInstance.GetFinancialCollectionDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, financialCollectionDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> EdFiFinancialCollectionDescriptor GetFinancialCollectionDescriptorsById (string id, string ifNoneMatch = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class GetFinancialCollectionDescriptorsByIdExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
                EdFiFinancialCollectionDescriptor result = apiInstance.GetFinancialCollectionDescriptorsById(id, ifNoneMatch, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiFinancialCollectionDescriptor> response = apiInstance.GetFinancialCollectionDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiFinancialCollectionDescriptorKeyChange&gt; KeyChangesFinancialCollectionDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesFinancialCollectionDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiFinancialCollectionDescriptorKeyChange> result = apiInstance.KeyChangesFinancialCollectionDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiFinancialCollectionDescriptorKeyChange>> response = apiInstance.KeyChangesFinancialCollectionDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> void PostFinancialCollectionDescriptor (EdFiFinancialCollectionDescriptor financialCollectionDescriptor)
...
namespace Example
{
    public class PostFinancialCollectionDescriptorExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new FinancialCollectionDescriptorsApi(config);
            var financialCollectionDescriptor = new EdFiFinancialCollectionDescriptor(); // EdFiFinancialCollectionDescriptor | The JSON representation of the \"financialCollectionDescriptor\" resource to be created or updated.

            try
            {
                // Creates or updates resources based on the natural key values of the supplied resource.
                apiInstance.PostFinancialCollectionDescriptor(financialCollectionDescriptor);
            }
            catch (ApiException  e)
            {
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostFinancialCollectionDescriptorWithHttpInfo(financialCollectionDescriptor);
}
catch (ApiException e)
{
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **financialCollectionDescriptor** | [**EdFiFinancialCollectionDescriptor**](EdFiFinancialCollectionDescriptor.md) | The JSON representation of the \&quot;financialCollectionDescriptor\&quot; resource to be created or updated. |  |
...
> void PutFinancialCollectionDescriptor (string id, EdFiFinancialCollectionDescriptor financialCollectionDescriptor, string ifMatch = null)
...
namespace Example
{
    public class PutFinancialCollectionDescriptorExample
    {
        public static void Main()
        {
            ...
            {
                // Updates a resource based on the resource identifier.
                apiInstance.PutFinancialCollectionDescriptor(id, financialCollectionDescriptor, ifMatch);
            }
            catch (ApiException  e)
            {
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutFinancialCollectionDescriptorWithHttpInfo(id, financialCollectionDescriptor, ifMatch);
}
catch (ApiException e)
{
