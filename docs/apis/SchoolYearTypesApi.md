# EdFi.OdsApi.Sdk.v62.Apis.All.SchoolYearTypesApi
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiSchoolYearType>> response = apiInstance.GetSchoolYearTypesWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, schoolYear, currentSchoolYear, id, schoolYearDescription, snapshotIdentifier);
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiSchoolYearType> response = apiInstance.GetSchoolYearTypesByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostSchoolYearTypeWithHttpInfo(schoolYearType);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutSchoolYearTypeWithHttpInfo(id, schoolYearType, ifMatch);
}
catch (ApiException e)
{
