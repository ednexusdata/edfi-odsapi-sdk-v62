# EdFi.OdsApi.Sdk.v62.Apis.All.MagnetSpecialProgramEmphasisSchoolDescriptorsApi
...
> List&lt;TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorDelete&gt; DeletesMagnetSpecialProgramEmphasisSchoolDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesMagnetSpecialProgramEmphasisSchoolDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorDelete> result = apiInstance.DeletesMagnetSpecialProgramEmphasisSchoolDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorDelete>> response = apiInstance.DeletesMagnetSpecialProgramEmphasisSchoolDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiMagnetSpecialProgramEmphasisSchoolDescriptor>> response = apiInstance.GetMagnetSpecialProgramEmphasisSchoolDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, magnetSpecialProgramEmphasisSchoolDescriptorId, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
    ApiResponse<EdFiMagnetSpecialProgramEmphasisSchoolDescriptor> response = apiInstance.GetMagnetSpecialProgramEmphasisSchoolDescriptorsByIdWithHttpInfo(id, ifNoneMatch, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> List&lt;TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorKeyChange&gt; KeyChangesMagnetSpecialProgramEmphasisSchoolDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesMagnetSpecialProgramEmphasisSchoolDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorKeyChange> result = apiInstance.KeyChangesMagnetSpecialProgramEmphasisSchoolDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorKeyChange>> response = apiInstance.KeyChangesMagnetSpecialProgramEmphasisSchoolDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Creates or updates resources based on the natural key values of the supplied resource.
    apiInstance.PostMagnetSpecialProgramEmphasisSchoolDescriptorWithHttpInfo(magnetSpecialProgramEmphasisSchoolDescriptor);
}
catch (ApiException e)
{
...
{
    // Updates a resource based on the resource identifier.
    apiInstance.PutMagnetSpecialProgramEmphasisSchoolDescriptorWithHttpInfo(id, magnetSpecialProgramEmphasisSchoolDescriptor, ifMatch);
}
catch (ApiException e)
{
