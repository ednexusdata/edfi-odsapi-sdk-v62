# EdFi.OdsApi.Sdk.v62.Apis.All.NeglectedOrDelinquentProgramDescriptorsApi
...
> List&lt;TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorDelete&gt; DeletesNeglectedOrDelinquentProgramDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class DeletesNeglectedOrDelinquentProgramDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves deleted resources based on change version.
                List<TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorDelete> result = apiInstance.DeletesNeglectedOrDelinquentProgramDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
{
    // Retrieves deleted resources based on change version.
    ApiResponse<List<TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorDelete>> response = apiInstance.DeletesNeglectedOrDelinquentProgramDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
...
> List&lt;TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKeyChange&gt; KeyChangesNeglectedOrDelinquentProgramDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, string snapshotIdentifier = null)
...
namespace Example
{
    public class KeyChangesNeglectedOrDelinquentProgramDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves resources key changes based on change version.
                List<TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKeyChange> result = apiInstance.KeyChangesNeglectedOrDelinquentProgramDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves resources key changes based on change version.
    ApiResponse<List<TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKeyChange>> response = apiInstance.KeyChangesNeglectedOrDelinquentProgramDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, snapshotIdentifier);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
