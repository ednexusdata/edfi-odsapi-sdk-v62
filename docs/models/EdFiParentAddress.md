# EdFi.OdsApi.Sdk.v62.Models.All.EdFiParentAddress
...
**Periods** | [**List&lt;EdFiParentAddressPeriod&gt;**](EdFiParentAddressPeriod.md) | An unordered collection of parentAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address. | [optional] 
**Ext** | **Object** | Extensions to the ParentAddress entity. | [optional] 
